  ...
  Sexy = {
    getOptions: function() {
      return {
        ...
        BoxStyles       : { 'width': 500 },
        OverlayStyles   : { 'backgroundColor': '#ebebeb', 'opacity': 0.7 },
        showDuration    : 200,
        closeDuration   : 100,
        moveDuration    : 500,
    ...
    initialize: function(options) {
      ...
      $('body').append('<div id="BoxOverlay"></div><div id="'+this.options.name
      +'-Box"><div id="'+this.options.name+'-InBox"><div id="'+this.options.name
    ...
    display: function(option) {
      if(this.options.display == 0 && option != 0 || option == 1) {
        ...
        if (!$.support.maxHeight) { //IE6
        	//alert("entro ie6 "+arrPageSizes[1]);
    ...
    preloadImages: function() {
      ...
      img[0].src = "js/sexyAlert/images/bg-box-bottom.png";
      img[1].src = "js/sexyAlert/images/bg-box-top.png";
      img[2].src = "js/sexyAlert/images/bg-box-body.png";
      
      //img[0].src = this.Box.css('background-image').replace(new RegExp("url\\('?([^']*)'?\\)", 'gi'), "$1");
      //img[0].src = img[0].src.replace("%22","");
      //img[0].src = img[0].src.replace("%22","");
      //img[0].src = img[0].src.replace("http://subastaviva.proirix.com/manager/","");
      //alert(img[0].src);
