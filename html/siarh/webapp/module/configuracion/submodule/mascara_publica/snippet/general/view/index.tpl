        ...
        <div class="m-portlet__body">
            ...
            <div class="form-group m-form__group row">
                <div class="col-lg-6">
                    <label>Orden:</label>
                    <div class="m-input-icon m-input-icon--right">
                        <input type="text" class="form-control m-input numero_entero" placeholder="Ingrese el Orden" name="item[orden]" name="" value="{$item.orden|escape:"html"}"  minlength="1" maxlength="2"
