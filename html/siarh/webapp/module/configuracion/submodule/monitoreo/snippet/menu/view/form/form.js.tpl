...
<script>
    var snippet_form_modal = function() {
        ...
        var handle_form_modal_submit=function(){
            // seteamos el input categoria con el valor por defecto de la categoria Padre
            var path = $('#cat_id').attr("data-id");
            $('#categoria').val(path);
        ...
        var handle_form_modal_btn_submit = function() {
            ...
            form_btn_submit.click(function(e) {
                ...
                $('#estado_desa_input').val($('#estado_desa').summernote('code'));
                $('#estado_gest_datos_input').val($('#estado_gest_datos').summernote('code'));
