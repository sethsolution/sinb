                ...
                columnDefs: [
                    {
                        ...
                        render: function(data, type, full, meta) {
                            var boton = ''+
                                ...
                                '<a href="javascript:item_update_{/literal}{$subcontrol}{literal}(\''+data+'\');" class="m--margin-right-5 btn btn-info btn-sm m--margin-bottom-5" title="Editar"><i class="fab fa-gg"></i>&nbsp; Modificar</a>'+
                                    {/literal}{/if}{literal}
                                '';
                            return boton;
                        },
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            return '<span class="m-badge m-badge--' + status[data].state + ' info m-badge--dot"></span>&nbsp;' +
