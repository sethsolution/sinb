...
class Snippet extends Table
{
    ...
    function get_item($id,$item_id){
        //$this->dbm->debug = true;
        $sql = "select * from ".$this->tabla["direccion"]." as p where p.itemId = '".$id."' and p.entidad_id = '".$item_id."'";
    ...
    function item_delete($id,$item_id){
        ...
        $res = $this->item_delete_sbm($id,$campo_id,$this->tabla["direccion"],$where);
