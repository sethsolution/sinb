...
,   "sub_control"=>"general"
,   "active"=>"1"
,   "icon" => "flaticon-share m--font-accent"
,   "new" => 1
);
...
,   "sub_control"=>"codice"
,   "active"=>"0"
,   "icon" => "fa flaticon-email m--font-accent"
,   "new" => 0
);
//-------------------------------------------------------------
$item_tab[]=array(
...
,   "sub_control"=>"oep"
,   "active"=>"0"
,   "icon" => "fa flaticon-home-1 m--font-accent"
,   "new" => 0
);
//-------------------------------------------------------------
...
,   "sub_control"=>"accesos"
,   "active"=>"0"
,   "icon" => "fa flaticon-logout m--font-accent"
,   "new" => 0
);
...
/*
$item_tab[]=array(
    "label"=>"Sistemas MMayA"
,   "id_name"=>"mmaya"
,   "sub_control"=>"mmaya"
,   "active"=>"0"
,   "icon" => "fa flaticon-imac m--font-accent"
,   "new" => 0
);
*/
//-------------------------------------------------------------
