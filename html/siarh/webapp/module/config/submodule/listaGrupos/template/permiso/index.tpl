...
<tr>
    <td class="titulo2" style="text-align:right;"> 
        <input type="button" value="Agregar permisos" class="boton" 
        id="btn_addPermiso" style="margin-right:20px;"/>
</td>
</tr>
</table>
...
<table style="width:100%;padding:0px;border-spacing: 0px;"
id="item_table" class="display cell-border hover order-column stripe">
<thead>
<tr>
    <td>#</td>
    <td>&nbsp;</td>
