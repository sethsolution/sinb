...
$(document).ready(function (){
                ...
                api.column(8, {page:'current'} ).data().each( function ( group, i ) {
                    if (last!==group ) {
                        ...
                        $(rows).eq( i ).before(
                            ...
                            '<div class="dder50 boton_m">'+
                            '<input type="button" value="Guardar" class="boton btn_savePermiso" rel="'+
                            textGroup[1]+'" style="margin-left:25px;" id="btn_mod_'+textGroup[1]+'"  >'+
                            '</div></td>'+
                            '<td style="text-align:center;"><input type="checkbox" class="input m_chckbx" id="m_crear_'+textGroup[1]+'" rel="'+textGroup[1]+'|1" ></td>'+
                ...
                api.column(9, {page:'current'} ).data().each( function ( groupSubmodulo, i ) {
                    if (lastSubmodulo!==groupSubmodulo ) {
                        ...
                        $(rows).eq( i ).before(
                            '<tr class="group2">'+
                            '<td colspan="3">'+
                            '<div class="titulo_subm">'+textGroup[0]+'</div>'+
                            '</td>'+
                            '<td></td>'+
                            '<td></td>'+
                            '<td></td>'+
  ...
  function addPermiso(title,data){
    ...
    dialogForm.dialog("option","width",550);
...
function itemDelete(id,data){
       ...
       $.msgbox("&iquest;Esta seguro de eliminar este registro?<br>Info<br><b>"+data+"</b>"
                 ,{type: "confirm"
