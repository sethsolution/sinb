...
class Index extends Table {
	...
	function __construct(){
	   global $CFG,$module,$smoduleName, $dbm;
       //$this->pref = $CFG->prefix;
       $this->tableName = $smoduleTableName."server";
       
       $smoduleTableName = "";
       $this->conteTableName[0] = $smoduleTableName."catalogo_formato";
       $this->conteTableName[1] = $smoduleTableName."server_layer";
	   $this->idName = "itemId";
       
       $this->userId = $_SESSION["userv"]["memberId"]; 

        /*Configuracion de preguntas II*/
       $this->dataItem = array("server"=>array(1=>array("campo"=>"nombre"
                                                        ,"descripcion"=>"Nombre"
                                                        ,"tipoInput"=>"text")
                                              ...
                                              ,3=>array("campo"=>"url"
                                                       ,"descripcion"=>"URL"
                                                       ,"tipoInput"=>"text"))
                              ,"layer"=>array(1=>array("campo"=>"nombre"
                                                        ,"descripcion"=>"Nombre"
                                                        ,"tipoInput"=>"text")
                                              ,2=>array("campo"=>"descripcion"
                                                       ,"descripcion"=>"Descripción"
                                              ...
                                              ,3=>array("campo"=>"layer"
                                                       ,"descripcion"=>"Layer"
                                                       ,"tipoInput"=>"text")
                                              ,4=>array("campo"=>"formatoId"
                                                       ,"descripcion"=>"Formato"
                                                       ,"tipoInput"=>"select"
                                                       ,"tabla"=>$this->conteTableName[0])
                                              ,5=>array("campo"=>"visible"
                                                       ,"descripcion"=>"Visible"
                                                       ,"tipoInput"=>"boolean")
                                              ,5=>array("campo"=>"transpararencia"
                                                       ,"descripcion"=>"Transparencia"
                                                       ,"tipoInput"=>"boolean")
                                              ,5=>array("campo"=>"opacidad"
                                                       ,"descripcion"=>"Opacidad"
                                                       ,"tipoInput"=>"text")
                                              ,5=>array("campo"=>"activo"
                                                       ,"descripcion"=>"Activo"
                                                       ,"tipoInput"=>"boolean")
                                              ,5=>array("campo"=>"orden"
                                                       ,"descripcion"=>"Orden"
    ...
    function itemDatatableRows($arrayGet){
        ...
        $dataItem = $this->getConfig("server");
...
//echo "=>".$sql;
	 ...
	 */
     ...
     function deleteItem($id){
        ...
        if($privFace["eliminar"]){
            ...
            if(trim($id)){
              ...
              $respermiso = $this->deleteItemTabla($id,1);
     ...
     function deleteItemTabla($id,$idx){
        ...
        $sql = "delete from ".$this->conteTableName[$idx]." WHERE serverId=".$id;//echo ":::".$sql;
        $resdelete = $dbm->Execute($sql);
    ...
    function getDataPrintItem($id){
        ...
        $sql = "SELECT i.*, p.nombre as proyectoName 
                ...
                LEFT JOIN vrhr_proyecto.item p ON p.itemId=i.proyectoId
                LEFT JOIN ".$this->conteTableName[8]." e ON e.itemId=i.encuestadorId
                LEFT JOIN vrhr_catalogo.catalogo_departamento d ON d.itemId=i.departamentoId
                LEFT JOIN vrhr_catalogo.catalogo_municipio m ON m.codigoINE=i.municipioId
