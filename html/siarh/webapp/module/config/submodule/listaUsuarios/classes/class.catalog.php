...
class Catalogo extends Table{
    ...
    function configCatalogListPermiso(){
        $this->addCatalogList($this->table01."core_modulo","core_modulo","","titulo","1","titulo","activo=1","");
    ...
    function configCatalogListIndex($tipo){
        //echo $this->table02;exit;
        $this->addCatalogList($this->table02."item","item","","","","itemId","");
        $this->addCatalogList($this->table01."core_grupo","grupo","","","","","");
    }

    function configCatalogListGeneral(){
        //$this->addCatalogList($this->table02."item","programa","","","","itemId","tipoId=1");
        $this->addCatalogList($this->table02."item","programa","","","","itemId","");
        $this->addCatalogList($this->table01."core_grupo","grupo","","","","","");
    }
