...
var snippet_geovisor = function() {
    ...
    var fn_obtener_ubicacion = function(lat, lon) {
        ...
        $.ajax({
            url: "?module=agrobiodiversidad&smodule=cultivos&accion=general_obtenerUbicacion",
            type: "POST",
            crossDomain: true,
    ...
    var fn_obtener_ubicacion_utm = function(utm_este, utm_norte, utm_zona) {
        ...
        $.ajax({
            url: "?module=agrobiodiversidad&smodule=cultivos&accion=general_obtenerUbicacionUtm",
            type: "POST",
            crossDomain: true,
