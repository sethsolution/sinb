...
<script>
    ...
    function item_set_recurso(id, recurso) {
        var url = '{/literal}{$getModule}{literal}&accion=adjuntos_setRecursoImagen&id={/literal}{$id}{literal}&adjId='+id;   
        swal({
    ...
    function item_button_recurso(id, ext) {
        ...
        if (opt_descarga != '' || opt_foto != '') {
            return '<span class="dropdown">'+
                '<a href="#" class="btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" data-toggle="dropdown" aria-expanded="true">'+
                    '<i class="la la-ellipsis-h"></i>'+
                '</a>'+
                '<div class="dropdown-menu dropdown-menu-right">'+opt_foto+opt_descarga+
                '</div>'+
            '</span>';
        } else {
            return null;
    ...
    var snippet_datatable_list = function() {
        ...
        var exporta_titulo = "LISTADO DE ARCHIVOS ADJUNTOS";
