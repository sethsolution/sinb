...
class Snippet extends Table {
    ...
    public function get_item_datatable_Rows($id){
         ...
         */
        $table = $this->tabla["cultivo_proyectos"];
        /**
         ...
         */
        $grilla = "grilla_cultivo_proyectos";
        /**
     ...
     **/
    function getProyectos($buscaProy, $cultivoId){
        global $db_conf_datatable;
        ...
        AND itemId NOT IN (
            SELECT proy_itemid FROM cultivo_proyectos WHERE cult_itemid=".$cultivoId."
            )
        LIMIT 15";
