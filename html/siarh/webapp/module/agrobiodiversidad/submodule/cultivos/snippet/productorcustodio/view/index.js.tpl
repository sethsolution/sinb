{literal}
<script>
var snippet_productorcustodio_form = function() {
    ...
    var handle_get_components = function() {
        ...
        btnCopiar.click(function() {
            $('#txtCusNombresApellidos').val($('#txtProdNombresApellidos').val());
            $('#txtCusSexo').val($('#txtProdSexo').val()).trigger("change");
            $('#txtCusCi').val($('#txtProdCi').val());
            $('#txtCusCelular').val($('#txtProdCelular').val());
        });
    }
...
jQuery(document).ready(function() {
    snippet_productorcustodio_form.init();
});
</script>
{/literal}