...
$db_prefix = "";
$db_datos = array();
$db_datos[] = $core->get_alias_campo("cultivos",$db_prefix,"");
$db_datos[] = $core->get_alias_campo("cultivo_productores_custodios",$db_prefix,"");
$db_datos[] = $core->get_alias_campo("especies",$db_prefix,"");
$db_datos[] = $core->get_alias_campo("especie_ecotipos",$db_prefix,"");
$db_datos[] = $core->get_alias_campo("cultivo_proyectos",$db_prefix,"");
$db_datos[] = $core->get_alias_campo("proyectos",$db_prefix,"");
$db_datos[] = $core->get_alias_campo("cultivo_informacion_adicional",$db_prefix,"");
$db_datos[] = $core->get_alias_campo("cultivo_adjuntos",$db_prefix,"");
