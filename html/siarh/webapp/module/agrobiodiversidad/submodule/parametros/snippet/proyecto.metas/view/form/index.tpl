    ...
    <form class="m-form m-form--state m-form--fit m-form--label-align-right" method="POST" action="{$getModule}" id="general_form" autocomplete="off">
        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">Catálogo metas</h3>
                </div>
            </div>
        </div>
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-6">
                ...
                <select class="form-control m-input select2" name="item[categoriameta_itemid]" id="cboCategoriaMetaId" required>
                    <option value="">Seleccione categoría</option>
                    {html_options options=$cataobj.categoria_metas selected=$item.categoriameta_itemid}
                </select>
            </div>
        </div>
