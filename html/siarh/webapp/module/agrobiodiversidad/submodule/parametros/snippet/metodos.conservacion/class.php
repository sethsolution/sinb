...
class Snippet extends Table {
    ...
    public function get_item_datatable_Rows() {
        ...
        $table = $this->tabla["c_metodos_conservacion"];
        /**
         ...
         */
        $grilla = "grilla_metodos_conservacion";
        /**
    ...
    function item_delete($id) {
        $campo_id = "itemId";
        $res = $this->item_delete_sbm($id, $campo_id, $this->tabla["c_metodos_conservacion"]);
        return $res;
    }
    ...
    function item_update($rec, $itemId, $que_form, $accion) {
         ...
         */
        $campo_id = "itemId";
        $res = $this->item_update_sbm($itemId, $respuesta_procesa, $this->tabla["c_metodos_conservacion"], $accion, $campo_id);
    ...
    function procesa_datos($que_form, $rec, $accion="new") {
        ...
        switch($que_form) {
            case 'campos_metodos_conservacion':
                /**
