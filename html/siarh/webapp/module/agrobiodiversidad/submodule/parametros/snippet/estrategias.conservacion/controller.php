...
switch($accion) {
    ...
    default:
        ...
        $grill_list = $subObjItem->get_grilla_list_sbm("grilla_estrategias_conservacion");
    ...
    case 'itemUpdate':
        ...
        $menu_tab = $subObjItem->get_item_tab_sbm($type, "tab_estrategias_conservacion");

        $smarty->assign("menu_tab", $menu_tab);
        $smarty->assign("menu_tab_active", "general");

        if($type=="update"){
            $item = $subObjItem->get_item($id,"c_estrategias_conservacion");
    ...
    case 'itemupdatesql':
        $respuesta = $subObjItem->item_update($item, $itemId, "campos_estrategias_conservacion", $type);
        $core->print_json($respuesta);
        break;
