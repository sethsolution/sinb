...
switch($accion) {
    ...
    default:
        ...
        $grill_list = $subObjItem->get_grilla_list_sbm("grilla_ejes_tematicos");
    ...
    case 'itemUpdate':
        ...
        $menu_tab = $subObjItem->get_item_tab_sbm($type, "tab_ejes_tematicos");

        $smarty->assign("menu_tab", $menu_tab);
        $smarty->assign("menu_tab_active", "general");

        if($type=="update"){
            $item = $subObjItem->get_item($id,"c_ejes_tematicos");
    ...
    case 'itemupdatesql':
        $respuesta = $subObjItem->item_update($item, $itemId, "campos_ejes_tematicos", $type);
        $core->print_json($respuesta);
        break;
