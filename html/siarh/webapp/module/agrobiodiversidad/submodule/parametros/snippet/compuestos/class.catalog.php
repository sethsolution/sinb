...
class Subcatalogo extends Table{
    ...
    public function conf_catalog_datos_general(){
        $this->addCatalogList($this->tabla["c_grupos_analisis"],"grupos_analisis","itemid","","","itemid","","");
        $this->addCatalogList($this->tabla["c_perfil_acidos_grasos"],"perfil_acidos_grasos","itemid","","","itemid","","");
    }
