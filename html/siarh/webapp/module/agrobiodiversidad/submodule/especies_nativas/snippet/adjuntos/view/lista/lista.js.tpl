...
<script>
    ...
    function item_button_download(id) {
        return '<a href="javascript:item_download(\''+ id +'\');" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Descargar"><i class="la flaticon-download m--font-brand"></i></a>';
    }
                ...
                columnDefs: [
                    {
                        ...
                        render: function(data, type, full, meta) {
                            var boton = '{/literal}{if $privFace.editar == 1}{literal}' + item_button_update(full.itemId) + '{/literal}{/if}{literal}{/literal}{if $privFace.eliminar == 1}{literal}' + item_button_delete(full.itemId) + '{/literal}{/if}{literal}{/literal}{if $privFace.eliminar == 1}{literal}' + item_button_download(full.itemId) + '{/literal}{/if}{literal}';
                            return boton;
                        }
                    },
                    {
