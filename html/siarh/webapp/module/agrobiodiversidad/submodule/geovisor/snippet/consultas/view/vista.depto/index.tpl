{include file="vista.depto/index.css.tpl"}
		...
		<div class="m-portlet__head-caption">
			<div class="m-portlet__head-title">
				...
				<h3 class="m-portlet__head-text">
					A continuación se muestra información sobre la cantidad y superficie de cultivos de especies por departamento.
				</h3>
				...
				<div class="m-widget1">
					<div class="m-widget1__item">
						<table class="table table-bordered m-table m-table--border-brand m-table--head-bg-brand table-sm">
							<thead>
								<tr>
									<th colspan="3">Cultivo de especies por departamento</th>
								</tr>
							</thead>
							<tbody>
								{foreach key=clave item=valor from=$datos_depto}
								<tr>
									<td class="text-left">{$valor.depto}</td>
					...
					<div class="m-widget1__item">
						<div class="row m-row--no-padding">
							<div class="col-md-6 col-lg-12 text-left">
								...
								<canvas id="deptoChart" width="auto" height="180"></canvas>
							</div>
						</div>
					</div>
					...
					<div class="m-widget1__item">
						<table class="table table-bordered m-table m-table--border-brand m-table--head-bg-brand table-sm">
							<thead>
								<tr>
									<th colspan="3">Superficie cultivado de especies por departamento</th>
								</tr>
							</thead>
							<tbody>
								{foreach key=clave item=valor from=$datos_depto}
					...
					<div class="m-widget1__item">
						<div class="row m-row--no-padding">
							<div class="col-md-6 col-lg-12 text-left">
								...
								<canvas id="deptoSupChart" width="auto" height="180"></canvas>
							</div>
						</div>
					</div>
					...
					<div class="m-widget1__item">
						<table class="table table-bordered m-table m-table--border-brand m-table--head-bg-brand table-sm">
							...
							<tbody>
								{foreach key=clave item=valor from=$datos_depto_especie}
								<tr>
					...
					<div class="m-widget1__item">
						<div class="row m-row--no-padding">
							<div class="col-md-6 col-lg-12 text-left">
								<p>Superficie especies silvestres y especies cultivadas</p>
								<canvas id="deptoEspecieChart" width="auto" height="180"></canvas>
							</div>
						</div>
					</div>
...
{include file="vista.depto/index.js.tpl"}