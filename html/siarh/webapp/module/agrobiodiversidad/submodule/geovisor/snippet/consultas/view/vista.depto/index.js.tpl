...
<script>
    ...
    var ctx = document.getElementById("deptoSupChart").getContext('2d');
    var deptoSupChart = new Chart(ctx, {
        type: 'pie',
        data: {
            labels: {/literal}{$etiquetas}{literal},
            datasets: [{
    ...
    var ctx = document.getElementById("deptoEspecieChart").getContext('2d');
    var deptoEspecieChart = new Chart(ctx, {
        type: 'pie',
        data: {
