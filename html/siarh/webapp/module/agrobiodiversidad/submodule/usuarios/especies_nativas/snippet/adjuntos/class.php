...
class Snippet extends Table {
    ...
    function item_update($rec, $itemId, $que_form, $accion, $item_id, $archivo_adjunto) {
        $tabla = $this->tabla["especie_nativa_adjuntos"];
        /**
        ...
        if( $res["res"]==1){
            ...
            $adjunto = $this->item_adjunto_sbm($archivo_adjunto, $item_id, $res["id"], $item, $tabla, $accion, 'espenativa_itemid');
        }
        return $res;
    }
    ...
    function procesa_datos($que_form, $rec, $accion="new") {
        ...
        switch($que_form){
            case 'campos_especie_nativa_adjuntos':
                /**
    ...
    public function get_item_datatable_Rows($id){
         ...
         */
        $table = $this->tabla["especie_nativa_adjuntos"];
        /**
         ...
         */
        $grilla = "grilla_especie_nativa_adjuntos";
        /**
         ...
         */
        $extraWhere = "espenativa_itemid=".$id;
        $groupBy = "";
        $having = "";
        /**
    ...
    function item_delete($id, $campo_referencia, $tabla_referencia) {
        ...
        $dir = $this->get_dir_item_archivo_sbm($item["espenativa_itemid"], 0);
