...
switch($accion) {
    ...
    default:
        ...
        $grill_list = $objItem->get_grilla_list_sbm("grilla_shapefiles");
    ...
    case 'itemUpdate':
        ...
        $menu_tab = $objItem->get_item_tab_sbm($type, "tab_shapefiles");
        $smarty->assign("menu_tab", $menu_tab);
        $smarty->assign("menu_tab_active", "general");

        if ($type == "update") {
            $item = $objItem->get_item($id, "shapefiles");
    ...
    case 'itemDelete':
        $res = $objItem->item_delete($id, "itemId", "shapefiles");
        $core->print_json($res);
        break;
