...
<script>
    ...
    function item_update(id) {
        var url = '{/literal}{$getModule}{literal}&accion=ecotipos_getForm&id={/literal}{$id}{literal}&ecoId='+id+'&type=update';
    ...
    function itemDeleteAction(id) {
        ...
        $.get( "{/literal}{$getModule}{literal}",
            {accion:"ecotipos_itemDelete", random:randomnumber, id:id},
            function(res){
                if(res.res == 1){
    ...
    function cargarFormulario() {
        var url = '{/literal}{$getModule}{literal}&accion=ecotipos_getForm&id={/literal}{$id}{literal}&type=new';
        $.get(url, function(respuesta) {
            modalContent.html('');
            modalContent.html(respuesta);
            modalWindow.modal('show');
    ...
    var snippet_datatable_list = function() {
        ...
        var initTable1 = function() {
            ...
            table_list = $('#index_lista').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{/literal}{$getModule}{literal}&accion=ecotipos_getItemList&id={/literal}{$id}{literal}',
                    type: 'POST',
                    data: {},
                },
                columns: [
