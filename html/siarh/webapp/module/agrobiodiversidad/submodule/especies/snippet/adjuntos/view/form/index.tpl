        ...
        <div class="form-group m-form__group row">
            <div class="col-lg-12">
                ...
                <div class="custom-file">
                    ...
                    <input type="hidden" name="adjunto_ancho" id="txtImgAncho" value="{$itemAdjunto.adjunto_ancho|escape:'html'}">
                    <input type="hidden" name="adjunto_alto" id="txtImgAlto" value="{$itemAdjunto.adjunto_alto|escape:'html'}">
                    
                </div>
            </div>
        </div>
        <div class="form-group m-form__group row" id="imgContenedor">
            <div class="col-lg-12">
                <p class="text-center">
                    <img class="img-thumbnail" id="imgVistaPrevia" width="350" height="350" src=""/>
                </p>
            </div>
        </div>
        <div class="form-group m-form__group row">
