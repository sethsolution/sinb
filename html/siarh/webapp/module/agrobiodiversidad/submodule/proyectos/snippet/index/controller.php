...
switch($accion) {
    ...
    default:
        ...
        $grill_list = $objItem->get_grilla_list_sbm("grilla_proyectos");
    ...
    case 'itemUpdate':
        ...
        $menu_tab = $objItem->get_item_tab_sbm($type, "tab_proyectos");
    ...
    case 'itemDelete':
        $res1 = $objItem->item_delete($id, "itemId", "proyecto_componentes");
        $res = $objItem->item_delete($id, "itemId", "proyectos");
        $core->print_json($res);
        break;
