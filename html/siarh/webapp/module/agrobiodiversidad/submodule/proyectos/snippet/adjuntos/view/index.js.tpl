{literal}
<script>
var snippet_proyecto_adjunto_form = function() {
    var idficha = '{/literal}{$id}{literal}';
    var type = '{/literal}{$type}{literal}';
    var general_form = $('#general_form');
    var general_btn_submit = $('#general_submit');
    var btnDescargarArchivo = $('#btnDescargarArchivo');
    ...
    var descargarArchivo = function(id) {
        url= "{/literal}{$getModule}&accion=adjuntos_descargarArchivo{literal}&id="+idficha;
...
jQuery(document).ready(function() {
    snippet_proyecto_adjunto_form.init();
});
</script>
{/literal}