...
<script>
    ...
    function item_update(id) {
        var url = '{/literal}{$getModule}{literal}&accion=componentes_getForm&id={/literal}{$id}{literal}&proycompoId='+id+'&type=update';
    ...
    function itemDeleteAction(id) {
        ...
        $.get( "{/literal}{$getModule}{literal}",
            {accion:"componentes_itemDelete", random:randomnumber, id:id},
            function(res){
                if(res.res == 1){
    ...
    function cargarFormulario() {
        var url = '{/literal}{$getModule}{literal}&accion=componentes_getForm&id={/literal}{$id}{literal}&type=new';
        $.get(url, function(respuesta) {
            modalContent.html('');
            modalContent.html(respuesta);
            modalWindow.modal('show');
    ...
    var snippet_datatable_list = function() {
        ...
        var exporta_titulo = "LISTADO DE COMPONENTES";
        ...
        var initTable1 = function() {
            ...
            table_list = $('#index_lista').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{/literal}{$getModule}{literal}&accion=componentes_getItemList&id={/literal}{$id}{literal}',
                    type: 'POST',
                    data: {},
                },
                columns: [
