...
<script>
    ...
    function item_download_file(id) {
        url= "{/literal}{$getModule}&accion=descargarArchivo{literal}&id="+id;
    ...
    function item_button_download_file(id) {
        return '<a href="javascript:item_download_file(\''+ id +'\');" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Descargar archivo"><i class="la flaticon-download m--font-brand"></i></a>';
    }
    ...
    var snippet_datatable_list = function() {
        ...
        var exporta_titulo = "LISTADO DE DOCUMENTOS";
                ...
                columnDefs: [
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            item_button_download_file(full.itemId)+'{/literal}{literal}'+
