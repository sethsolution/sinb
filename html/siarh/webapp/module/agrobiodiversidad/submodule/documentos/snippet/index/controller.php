...
switch($accion) {
    ...
    default:
        ...
        $grill_list = $objItem->get_grilla_list_sbm("grilla_documentos");
    ...
    case 'itemUpdate':
        ...
        $menu_tab = $objItem->get_item_tab_sbm($type, "tab_documentos");
    ...
    case 'itemDelete':
        $res = $objItem->item_delete($id, "itemId", "documentos");
        $core->print_json($res);
        break;

    case 'descargarArchivo':
        $objItem->descargarArchivo($id);
        break;
