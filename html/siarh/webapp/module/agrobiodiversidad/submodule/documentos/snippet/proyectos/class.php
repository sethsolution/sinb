...
class Snippet extends Table {
    ...
    function procesa_datos($que_form, $rec, $accion="new") {
        ...
        switch($que_form){
            case 'campos_documento_proyectos':
                /**
    ...
    public function get_item_datatable_Rows($id){
         ...
         */
        $table = $this->tabla["documento_proyectos"];
        /**
         ...
         */
        $grilla = "grilla_documento_proyectos";
        /**
     ...
     **/
    function getProyectos($buscaProy, $documentoId){
        global $db_conf_datatable;
        ...
        AND itemId NOT IN (
            SELECT proy_itemid FROM documento_proyectos WHERE doc_itemid=".$documentoId."
            )
        LIMIT 15";
