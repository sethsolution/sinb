...
class Snippet extends Table
{
    ...
    function item_update($rec,$itemId,$que_form,$accion,$item_id){
      ...
      // print_struc($respuesta_procesa);exit;
         ...
         */
        $campo_id="itemId";
        $res = $this->item_update_sbm($itemId,$respuesta_procesa,$this->tabla["c_tipo_documento"],$accion,$campo_id);
        $res["accion"] = $accion;
    ...
    function item_delete($id,$item_id){
        ...
        $campo_id="itemId";
        $where = "itemid='".$id."'";
        $res = $this->item_delete_sbm($id,$campo_id,$this->tabla["c_tipo_documento"],$where);
        return $res;
