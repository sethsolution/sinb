...
class Snippet extends Table
{
    ...
    function item_update($rec,$itemId,$que_form,$accion,$item_id){
         ...
         */
        $campo_id="itemId";
        $res = $this->item_update_sbm($itemId,$respuesta_procesa,$this->tabla["c_especie"],$accion,$campo_id);
        $res["accion"] = $accion;
    ...
    function get_item($id){
        $sql = "select * from ".$this->tabla["c_especie"]." as p where p.itemId = '".$id."'";
    ...
    function item_delete($id,$item_id){
        ...
        $campo_id="itemId";
        $where = "itemid='".$id."'";
        $res = $this->item_delete_sbm($id,$campo_id,$this->tabla["c_especie"],$where);
        return $res;
