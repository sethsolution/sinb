    ...
    {if $item_padre.estado_id ==1 or $item_padre.estado_id ==3}
        <div class="alert alert-primary alert-dismissible fade show   m-alert m-alert--air m-alert--outline" role="alert">
            ...
            <span class="m-nav__link-wrap">
                <span class="m-nav__link-text">Si ya completo el registro de la información solicitada, envie su solicitud, dando clic sobre la opción <strong>"ENVIAR SOLICITUD"</strong> de la parte superior.</span>
