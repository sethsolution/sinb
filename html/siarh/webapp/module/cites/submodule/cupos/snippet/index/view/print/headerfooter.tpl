...
<header>
        ...
        <tr>
          ...
          <td class="tituloHeader header">
              CONVENCIÓN SOBRE EL COMERCIO <BR>INTERNACIONAL DE ESPECIES <BR>AMENAZADAS DE FAUNA Y FLORA SILVESTRE
          </td>
          <td class="logo02 header"><img src="{$templateDir}images/pdf/cites_logo.jpg" width="70px" /></td>
      </tr>
    </table>
</header>
<footer>
