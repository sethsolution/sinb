...
<div class="portlet__body m--margin-5">
    <div class=" row m--padding-bottom-5 busqueda_panel cuadro-verde" >
        ...
        <div class="col-lg-12 titulo m--margin-bottom-5 m--padding-left-5">Criterios de búsqueda para Reporte GADs </div>

        <div class="col-lg-4 m--margin-bottom-10-tablet-and-mobile">
            <label>Tipo de Institución:</label>
            <select class="form-control m-input select2_busqueda" id="categoria"
                    name="item[tipo_institucion]"  data-col-index="2">
                <option value="0">Todos</option>
                {html_options options=$cataobj.tipo_institucion}
            </select>
        </div>
{*
        <div class="col-lg-4 m--margin-bottom-10-tablet-and-mobile">
