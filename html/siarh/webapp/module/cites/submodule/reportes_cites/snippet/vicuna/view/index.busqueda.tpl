...
<div class="portlet__body m--margin-5">
    <div class=" row m--padding-bottom-5 busqueda_panel cuadro-verde" >
       ...
       <div class="col-lg-4 m--margin-bottom-10-tablet-and-mobile">
            <label>Empresa de exportador (quien solicita tramite): </label>
        ...
        <div class="col-lg-4 m--margin-bottom-10-tablet-and-mobile">
            <label>Nro. de venta (factura comercial de vicuña): </label>
            <input type="text" class="form-control m-input mayus"
                   placeholder="Ingrese el nro de venta " name="item[venta_numero]"
                    value=""
                    minlength="2">
        </div>
