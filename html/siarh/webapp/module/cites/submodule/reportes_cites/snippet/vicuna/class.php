...
";
         ...
         */
        $where = "WHERE ce.especie_id = 426 and c.estado_id = 4 ";
        ...
        if(trim($item["venta_numero"])!=""){
            $dato = $item["venta_numero"];
            $where .= " AND c.numero_venta LIKE '%".$dato."%' ";
        }
