    ...
    <div class="m-portlet__body m--padding-bottom-5 m--padding-top-5">
        ...
        table-sm m-table m-table--head-bg-success {*m--hide*}" id="tabla_{$subcontrol}">
            ...
            <tr>
                ...
                <th rowspan="2" class="cabecera">Nombre de Empresa destino (Importador) </th>
                ...
                <th rowspan="2" class="cabecera">Monto Factura comercial (bs)</th>
                <th rowspan="2" class="cabecera">Monto Factura comercial ($us)</th>
                <th rowspan="2" class="cabecera">Nro. de venta</th>
            </tr>
            <tr>
