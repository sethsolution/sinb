    ...
    <form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{$getModule}" id="general_form">
        ...
        <div class="m-portlet__body m--padding-bottom-5 m--padding-top-5">
                    ...
                    <div class="form-group m-form__group row m--padding-top-5 m--padding-bottom-5 " >
                        <div class="col-lg-12  m-form__group-sub" >
                            <div class="cuadro m--padding-5 row">
                                ...
                                <div class="col-lg-6 m-form__group-sub">
                                    <label class="form-control-label">Nombre del Destinario (coincidir con el importador):</label>
                                ...
                                <div class="col-lg-12 titulo m--margin-bottom-5 m--padding-left-5"></div>
                                <div class="col-lg-12 titulo m--margin-bottom-5 m--padding-left-5">
                        ...
                        <div class="col-lg-12  m-form__group-sub" >
                            <div class="cuadro m--padding-5 row">
                                ...
                                <div class="col-lg-3 m-form__group-sub">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control m-input numero_entero"
                                               placeholder="Ingrese precinto inicial" name="item[precinto_inicio]"
                                ...
                                <div class="col-lg-3 m-form__group-sub">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control m-input numero_entero"
                                               placeholder="Ingrese último precinto" name="item[precinto_ultimo]"
            ...
            {*----------------------------------------------------------------------------------*}
                ...
                {/if}
            {*----------------------------------------------------------------------------------*}
                {if  $item.tipo_id == 2 or $item.tipo_id == 3}
                    <div class="form-group m-form__group row m--padding-top-5 m--padding-bottom-5 " >
                        <div class="col-lg-12  m-form__group-sub" >
                            <div class="cuadro m--padding-5 row">
                                <div class="col-lg-12 titulo m--margin-bottom-5 m--padding-left-5">
                                    Permiso CITES (En caso de reexportación, importación)
                                </div>
                                <div class="col-lg-6 m-form__group-sub">
                    ...
                    <div class="form-group m-form__group row m--padding-top-5 m--padding-bottom-5 " >
                        <div class="col-lg-12  m-form__group-sub" >
                            <div class="cuadro m--padding-5 row">
                                ...
                                <div class="col-lg-6 m-form__group-sub">
                                    <br>
                                    <label class="form-control-label">Recuerde que 6 especies es límite para una solicitud de certificación CITES, si supera esa cantidad debera solicitar mas certificados. </label>
