    ...
    <div class="m-section m--padding-bottom-5 m--margin-bottom-5 m--hide" id="obs_cuadro">
        <div class="m-widget1 cuadro-obs m--padding-10 m--margin-bottom-10">
            ...
            <div class="m-widget1__item resumen_global" >
                <div class="row m-row--no-padding align-items-center">
                    <div class="col">
                        <span class="m-widget1__item">Observación en Especies</span>
                    </div>
                    <div class="col m--align-right">
            ...
            <div class="m-widget1__item resumen_global" >
                <div class="row m-row--no-padding align-items-center">
                    <div class="col">
                        <span class="m-widget1__item">Observación en Formulario Adicional</span>
                    </div>
                    <div class="col m--align-right">
            ...
            <div class="m-widget1__item resumen_global" >
                <div class="row m-row--no-padding align-items-center">
                    <div class="col">
                        <span class="m-widget1__item">Observación en Requisitos </span>
                    </div>
                    <div class="col m--align-right">
            ...
            <div class="m-widget1__item resumen_global {if $item.sustitucion_cites==1 }m--hide{/if}" >
                <div class="row m-row--no-padding align-items-center">
                    <div class="col">
                        <span class="m-widget1__item">Observación en Depósitos </span>
                    </div>
                    <div class="col m--align-right">
            ...
            <div class="m-widget1__item resumen_global {if $item.sustitucion_cites==0 }m--hide{/if}" >
                <div class="row m-row--no-padding align-items-center">
                    <div class="col">
                        <span class="m-widget1__item">Observación en Requisitos de <i><strong>Sustitución</strong></i></span>
                    </div>
                    <div class="col m--align-right">
                        <span class="m-widget1__number m--font-info" id="obs_sustitucion_requisitos">0</span>
                    </div>
                </div>
            </div>
            ...
            <div class="m-widget1__item resumen_global {if $item.sustitucion_cites==0 }m--hide{/if}" >
                <div class="row m-row--no-padding align-items-center">
                    <div class="col">
                        <span class="m-widget1__item">Observación en Formulario Adicional Requisitos de <i><strong>Sustitución</strong></i></span>
                    </div>
                    <div class="col m--align-right">
                        <span class="m-widget1__number m--font-info" id="obs_sustitucion_form">0</span>
                    </div>
                </div>
            </div>
            ...
            <div class="m-widget1__item resumen_global {if $item.sustitucion_cites==0 }m--hide{/if}" >
                <div class="row m-row--no-padding align-items-center">
                    <div class="col">
                        <span class="m-widget1__item">Observación en depósitos de <i><strong>Sustitución</strong></i></span>
                    </div>
                    <div class="col m--align-right">
                        <span class="m-widget1__number m--font-info" id="obs_sustitucion_pagos">0</span>
                    </div>
                </div>
            </div>
