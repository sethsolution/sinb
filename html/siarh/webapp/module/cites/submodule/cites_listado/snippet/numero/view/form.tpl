{include file="index.css.tpl"}
    ...
    <div class="form-group m-form__group row m--padding-bottom-5 m--padding-top-5" >
        ...
        <div class="col-lg-6 m-form__group-sub m--padding-right-5 m--padding-left-5" >
            <div class="cuadro m--padding-10">
                <div class="col-lg-12 titulo m--margin-bottom-5 m--padding-left-5">Número de estampilla de seguridad:</div>
                <div class="input-group">
                    <input type="text" class="form-control m-input numero_entero"
                           placeholder="Ingrese el Número de estampilla de seguridad" name="item[numero_estampilla]"
                            {$privFace.input} value="{$item.numero_estampilla|escape:'html'}">
                </div>
                <span class="m-form__help text-info ">(si corresponde)</span>
            </div>
        </div>

    </div>
    {if $item_padre.estado_id == 3 or $item_padre.estado_id == 2 or $item.estado_id == 3 or $item.estado_id == 2 }
