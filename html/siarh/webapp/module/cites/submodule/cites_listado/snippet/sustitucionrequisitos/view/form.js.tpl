    ...
    var snippet_general_form = function() {
        ...
        var showResponse = function (responseText, statusText) {
            ...
            if(responseText.res ==1){
                ...
                if(responseText.accion =='update') {
                    swal({type: 'success'
                        ,title: 'Se guardo todo con exito!'
                        ,showConfirmButton: false
                        ,timer: 2000
                        ,onClose: () => {
                            //$('#sustitucionpagos_tab').trigger('click');
                        }
                    });
        ...
        var options = {
            ...
            , data: {
                ...
                ,itemId:'{/literal}{$item.itemId}{literal}'
        ...
        var handle_general_form_submit = function() {
            ...
            general_btn_submit.click(function(e) {
                ...
                console.log($('#observacion_detalle').summernote('code'));
                console.log($('#observacion_input_detalle').val());
