...
<div class="col-lg-12 m--margin-bottom-5 m--padding-left-5">Registre el número del certificado de dispensación FISICO a imprimir (si son mas de dos certificados debe registrar todos los números)</div>
