                ...
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-wrapper">
                        <div class="m-portlet__head-caption">
                            ...
                            {/if}
                            {*
                                                        <a href="/{$miga.modulo.carpeta}/{$miga.smodulo.carpeta}/" id="btn_imprime_excel"
                                                           class="btn btn-primary m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
                                                            <span><i class="fa fa-print"></i><span>Excel Para Imprimir</span></span>
                                                        </a>
                            *}
                        </div>
                        ...
                        <div class="m-portlet__head-tools">
                            {if $item.estado_id == 2 }
                                <a href="#" class="btn btn-warning m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10 m--hide"
                            ...
                            {else}{if $item.estado_id == 4}
                                <div class="cuadro-verde m--padding-10 m--margin-bottom-10" style=" height: 50%">
                                    <div class="titulomensaje m--margin-bottom-5 m--padding-left-5 m--font-bold">La solicitud fue aprobada y se envió una notificación.</div>
                                </div>
                            {/if}
                            {/if}
