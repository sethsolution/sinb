    ...
    var snippet_item = function () {
        ...
        var aprobar_accion = function () {
            ...
            $.get( url,{
                ...
                function(res){
                    ...
                    if(res.res == 1){
                        swal.close();
                        swal({position: 'top-center',type: 'success',title: 'La solicitud de certificado de Dispensación fue aprobada<br> Se envió un mail electronico al usuario. ',showConfirmButton: false,timer: 2000});
        ...
        var aprobar = function (){
            swal({
                ...
                html: 'Recuerde que una vez aprobada la solicitud, se enviara un email de aprobación al usuario y  <br>'+
