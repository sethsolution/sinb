<div style="font-size: 13px;margin-bottom: 19px;width: 100%;font-family:'Roboto', Tahoma, Verdana, Segoe, sans-serif;">
    ...
    <div style="margin-right: 40px; margin-left: 40px; margin-top: 10px;">
        <div style="text-align: center;">
            <h2 style="margin: 0px;">Su solicitud de MARCAS DE SEGURIDAD fue Aprobado en CITES Bolivia</h2>
        </div>


        El administrador del sistema CITES aprobo su solicitud de Marcas de seguridad, <strong>Felicidades!!!.</strong>
        <br><br>
