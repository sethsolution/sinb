...
class Index extends Table {
    ...
    function get_item($idItem){
        ...
        if($idItem!=''){
            ...
            $sql = "SELECT
                   i.*, e.nombre as empresa, e.ciudad as ciudad, d.nombre as departamento
                    FROM ".$this->tabla["aprovechamiento"]." AS i
                    LEFT JOIN ".$this->tabla["c_aprovechamiento_tipo"]." AS ct ON ct.itemId = i.tipo_id
                    LEFT JOIN ".$this->tabla["empresa"]." AS e ON e.itemId = i.empresa_id
                    LEFT JOIN catalogo_departamento AS d ON d.itemId = e.departamento_id
    ...
    function item_delete($id){
        ...
        $campo_id="itemId";
        $where =  "";
        $res = $this->item_delete_sbm($id,$campo_id,$this->tabla["aprovechamiento"], $where);
        return $res;
    }
    /**
     * Get Resumen
