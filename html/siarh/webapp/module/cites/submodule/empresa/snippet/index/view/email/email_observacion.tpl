<div style="font-size: 13px;margin-bottom: 19px;width: 100%;font-family:'Roboto', Tahoma, Verdana, Segoe, sans-serif;">
    ...
    <div style="margin-right: 40px; margin-left: 40px; margin-top: 10px;">
        ...
        <h2 style="margin: 0px;">Observaciones en el registro de USUARIO</h2>
        </div>

        Se ha revisado su solicitud de registro de usuario y tiene observaciones
        que debe corregir para poder ser aprobado en el sistema CITES.
        <br><br>
...
1px solid #53ba3e; border-bottom: 1px solid #53ba3e; border-left: 1px solid #53ba3e; padding-top:
 ...
 mso-line-height-alt: 32px;"><strong>Entrar a CITES Bolivia</strong></span></span></a>
        ...
        {if $item.observado == 1}
            <h3>Datos Generales (observación)</h3>
            <div style="color: red;">
            {$item.observacion}
            </div>
        {/if}
        ...
        {if $item.requisitos_observado == 1}
            <h3>Datos de Requisitos (observación)</h3>
            <div style="color: red;">
        ...
        {if $requisitos_total != 0 }
            <h3>Documentación de Requisitos (observación)</h3>
        ...
        <br>
        {if $pagos_total != 0 }
            <h3>Boleta de Depósitos (observación)</h3>
    ...
    <br>
    Este correo es electrónico es generado de manera automática, por favor, no responda a este mensaje.
