    ...
    var snippet_form_modal = function() {
        ...
        var showResponse = function (responseText, statusText) {
            ...
            if(responseText.res ==1){
                ...
                if(responseText.accion =='update') {
                    swal({type: 'success',title: 'Los datos se han guardado correctamente!',
                    ...
                    swal({type: 'success',title: 'Se ha creado el registro correctamente!',
                        showConfirmButton: false,
                        timer: 2000
                        /*
                        ,
        ...
        var handle_form_modal_btn_submit = function() {
            ...
            form_btn_submit.click(function(e) {
                e.preventDefault();
                swal({
                    title: '¿Esta seguro de cambiar el estado de este archivo?',
