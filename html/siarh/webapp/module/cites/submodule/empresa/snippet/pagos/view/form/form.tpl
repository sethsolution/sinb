...
<form class="m-form m-form--fit m-form--label-align-right" method="POST"
            ...
            <div class="col-lg-6">
                    ...
                    <div class="col-lg-4 m-form__group-sub">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control m-input numero_decimal monto"
                                   ...
                                   required data-msg="Campo requerido"
                                   name="item[monto]"  disabled value="{$item.monto|escape:'html'}">
                    ...
                    <div class="col-lg-4 m-form__group-sub">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control m-input numero_entero" placeholder="Ingrese el número"
                                   required data-msg="Campo requerido"
                                   name="item[numero_boleta]" disabled value="{$item.numero_boleta|escape:'html'}">
                ...
                <div class="form-group  m-form row">
                    <div class="col-lg-12 m-form__group-sub">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control m-input" placeholder="Ingrese el Nombre"
                                   name="item[nombre_depositante]" disabled
    ...
    <div class="modal-footer">
        ...
        {if $privFace.editar == 1}
            <button type="button" class="btn btn-focus" id="form_modal_submit_{$subcontrol}">Cambiar Estado</button>
        {/if}
    </div>
</form>
