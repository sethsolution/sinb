<div style="font-size: 13px;margin-bottom: 19px;width: 100%;font-family:'Roboto', Tahoma, Verdana, Segoe, sans-serif;">
    ...
    <div style="margin-right: 40px; margin-left: 40px; margin-top: 10px;">
        <div style="text-align: center;">
            <h2 style="margin: 0px;">Su usuario fue Aprobado en CITES Bolivia</h2>
        </div>


        El administrador del sistema CITES aprobo su solicitud al sistema, <strong>Felicidades!!!.</strong>
        <br><br>
        Para poder ingresar al sistema CITES, haz click en la siguiente opci&oacute;n:
        <br><br><br>
        <div style="text-align: center;">
...
1px solid #53ba3e; border-bottom: 1px solid #53ba3e; border-left: 1px solid #53ba3e; padding-top:
 ...
 mso-line-height-alt: 32px;"><strong>Entrar a CITES Bolivia</strong></span></span></a>
        ...
        <br>
        Este correo es electr&oacute;nico es generado de manera autom&aacute;tica, por favor, no responda a este mensaje.
