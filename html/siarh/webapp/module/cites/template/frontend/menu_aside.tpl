<div id="m_ver_menu"
    ...
    <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow " style="padding: 0px;">
        ...
        <li class="m-menu__item text-center" aria-haspopup="true"  style=" border-bottom: 1px dotted #525780;">
            <a  href="/index.php?module=cites&smodule=index" class="m-menu__link ">

                <span class="m-menu__link-title">
                    <span class="m-menu__link-wrap">
                        <span class="m-menu__link-text"><img alt="MMAyA" src="/module/cites/template/images/logo/logo_bolivia_blanco.png" width="160"/></span>
                    </span>
                </span>
            </a>
        </li>
