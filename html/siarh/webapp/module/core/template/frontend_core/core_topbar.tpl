            ...
            <li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" m-dropdown-toggle="click">
                <a href="#" class="m-nav__link m-dropdown__toggle">
                    <span class="m-topbar__userpic">
                        <img src="index.php?accion=getPhoto" class="m--img-rounded m--marginless m--img-centered" alt=""/>
                    </span>
                        ...
                        <div class="m-dropdown__header m--align-center" style="background: url(template/user/images/core/perfil/user_profile_bg.jpg); background-size: cover;">
                            <div class="m-card-user m-card-user--skin-dark">
                                ...
                                <div class="m-card-user__details">
                                    <span class="m-card-user__name m--font-weight-500">{$usuarioInfo.nombres} {$usuarioInfo.apellido_paterno} {$usuarioInfo.apellido_materno}</span>
                                    <a href="" class="m-card-user__email m--font-weight-300 m-link">Usuario:{$usuarioInfo.usuario}</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    *}
                                    ...
                                    <li class="m-nav__item">
                                        <a href="index.php?action=close" class="btn btn-danger m-btn m-btn--custom m-btn--bolder m-btn--icon">
                                            <span><i class="fa fa-times"></i><span>Cerrar Ssion</span></span>
                                        </a>
                                    </li>
