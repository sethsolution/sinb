...
<head>
    ...
    <!--begin::Page Vendors -->
    <link href="themes/metro/assets/vendors/custom/datatables/datatables.bundle.css?id=23499" rel="stylesheet" type="text/css" />
    <!--end::Page Vendors -->

    <!--begin::Base Styles -->
    <link href="themes/metro/assets/vendors/base/vendors.bundle.css?id=23499" rel="stylesheet" type="text/css" />
    <link href="themes/metro/assets/demo/default/base/style.bundle.css?id=23499" rel="stylesheet" type="text/css" />
    <!--end::Base Styles -->
    <!--begin::Fonts Styles -->
...
<body class="m-page--fluid m--skin- m-page--loading m-page--loading-enabled m-content--skin-light2 m-header--fixed
m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas
m-aside--offcanvas-default
 m-footer--push {* m-brand--minimize m-aside-left--minimize *}" style="">
        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="m-subheader m--padding-top-5" >
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="m-subheader__title m-subheader__title--separator">Menu Principal</h3>
                        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                            <li class="m-nav__item m-nav__item--home">
                                <a href="index.php?module=core&smodule=index" class="m-nav__link m-nav__link--icon"><i class="m-nav__link-icon la la-home"></i></a>
                            </li>

                            <li class="m-nav__item">
                                <a href="index.php?module=core&smodule=index" class="m-nav__link"><span class="m-nav__link-text">Inicio</span></a>
                            </li>
