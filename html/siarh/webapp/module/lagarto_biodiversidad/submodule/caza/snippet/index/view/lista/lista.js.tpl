...
<script>
    ...
    function item_download(data){
        ...
        req.open("GET", direccionAPI+'caza/pdf/'+data, true);
        ...
        req.onload = function (event) {
            ...
            var fileName = "caza-"+data+".pdf";//if you have the fileName header available
    ...
    var snippet_datatable_list = function () {
        ...
        var exporta_titulo = "Reportes_Caza";
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            var boton = ''+
                                    {/literal}{if $privFace.editar == 1}{literal}
                                        '<a  href="javascript:item_download(\''+data+'\');" class="btn m-btn--hover-success m-portlet__nav-link btn m-btn m-btn--icon m-btn--icon-only m-btn--pill " title="View">'+
