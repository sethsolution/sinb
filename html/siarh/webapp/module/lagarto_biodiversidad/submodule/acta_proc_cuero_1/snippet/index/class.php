...
class Index extends Table {
    ...
    function obtenerDisponibleCuero(){
        $q1="SELECT SUM(tcc.total_chalecos) as sumT,SUM(tcc.total_colas) as colasT
        ...
        $q2="SELECT SUM(ac.entregado_chalecos) as enT,SUM(ac.entregado_colas) as colasE
            FROM acta_cuero ac
            ...
            WHERE
            ac.estado!=0 
		and ac.gestion_itemId='".date("Y")."' and
        ...
        $enT = $enT->fields;
        return [$sumT["sumT"]-$enT["enT"],$sumT["colasT"]-$enT["colasE"]];
    }
    function obtenerLongitudTotal($id_acta=""){
    ...
    function get_item_datatable_Rows($gestion=2019){
    ...
    function item_delete($id){
        $campo_id="itemId";
            $res = $this->item_soft_delete_sbm($id,$campo_id,"acta_cuero","estado=2");
        return $res;
    }
