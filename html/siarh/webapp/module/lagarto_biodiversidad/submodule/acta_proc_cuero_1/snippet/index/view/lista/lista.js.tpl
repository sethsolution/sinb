...
<script>
    ...
    var snippet_datatable_list = function () {
        ...
        var exporta_titulo = "Venta_Cuero_Representante_Legal";
                ...
                columnDefs: [
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            if(full["estado"]==1){
                                ...
                                '<a href="javascript:item_download(\''+data+'\');" class=" m-portlet__nav-link btn m-btn m-btn--hover-warning m-btn--icon m-btn--icon-only m-btn--pill " title="View">'+
