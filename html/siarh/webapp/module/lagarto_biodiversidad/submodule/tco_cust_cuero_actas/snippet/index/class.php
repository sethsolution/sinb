...
class Index extends Table {
    ...
    function get_item($idItem,$tipoTabla,$variante=""){
        ...
        if($idItem!=''){
            if($tipoTabla=='tipo'){
                ...
                $sqlFrom = ' caza i
                         LEFT JOIN usuario u1 on u1.itemId=i.userCreate
                         LEFT JOIN usuario u2 on u2.itemId=i.userUpdate';
    ...
    function item_delete($id){
        $campo_id="itemId";
        $res = $this->item_soft_delete_sbm($id,$campo_id,$this->tabla["c_indice"]);
        return $res;
    }
