...
class Index extends Table {
        ...
        $longitudes=["0 a 1,14","1,15 a 1,19","1,20 a 1,24","1,25 a 1,29","1,30 a 1,34","1,35 a 1,39","1,40 a 1,49","1,50 a max"];
            ...
            if(!$info[0]["estado"]){
                for($i=0;$i<count($info);$i++){
                    $info[$i]["primera"]=empty($info[$i]["primera"])?0:$info[$i]["primera"];
                    ...
                    $info[$i]["precio_unidad"]=$info[$i]["precio_unidad"]==null?0:$info[$i]["precio_unidad"];
                    $info[$i]["precio_total"]=$info[$i]["precio_total"]==null?0:$info[$i]["precio_total"];
                }
            }
            $filas=$info;
    ...
    function item_delete($id){
        $campo_id="itemId";
        $res = $this->item_soft_delete_sbm($id,$campo_id,"acta_carne");
        return $res;
    }
