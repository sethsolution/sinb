...
<script>
    ...
    function item_download(data){
        ...
        req.open("GET", direccionAPI+'acta-carne/pdf/'+data, true);
        ...
        req.onload = function (event) {
            ...
            var fileName = "carne-"+data+".pdf";//if you have the fileName header available
    ...
    var snippet_datatable_list = function () {
        ...
        var exporta_titulo = "Venta_Carne_Responsable_Empresa";
