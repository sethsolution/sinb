...
class Index extends Table {
    ...
    function get_item($idItem,$tipoTabla,$variante=""){
        ...
        if($idItem!=''){
            if($tipoTabla=='tipo'){
                $sqlSelect = ' i.*,mn.nombre municipio, pv.nombre provincia, dp.nombre departamento
                           , CONCAT_WS(" ",u1.nombre,u1.apellido) as userCreater
                           , CONCAT_WS(" ",u2.nombre,u2.apellido) as userUpdater';
                $sqlFrom = ' catalogo_tco i
                         ...
                         LEFT JOIN vrhr_territorio.municipio mn on mn.itemId=i.municipio_itemId
    ...
    function item_delete($id){
        $campo_id="itemId";
        //$res = $this->item_delete_sbm($id,$campo_id,"tco");
        return false;
    }
