...
<script>
    ...
    var snippet_datatable_list = function () {
        ...
        var exporta_titulo = "Custodia_De_Carne_TCO";
...
if(!{/literal}{json_encode($gestionVer)}{literal}){
            ...
            table_list = $('#index_lista').DataTable({
                ...
                columns: [
                    {/literal}
                    {foreach from=$grill_list item=row key=idx}{literal}
					
                        {data: '{/literal}{$row.field}{literal}'} ,
                    {/literal}{/foreach}
                    {literal}
                ],
                columnDefs: [
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            var boton = ''+
                                    {/literal}{if $usuarioInfo.rol_itemId == 1||$usuarioInfo.rol_itemId == 3}{literal}
                                ...
                                '<i class="la la-eye m--font-brand"></i>'+
                                '</a>'+
                                    {/literal}{/if}{literal}
                                ...
                                '</a>'+
                                    {/literal}{/if}{literal}
									{/literal}{if $usuarioInfo.rol_itemId == 6}{literal}
                                '<a  class="m-portlet__nav-link btn m-btn  m-btn--icon m-btn--icon-only m-btn--pill" title="View">'+
                                '<p class="">-</p>'+
                                '</a>'+
                                    {/literal}{/if}{literal}
                                '';
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            var boton = String(data).padStart(4,"0");
                            return boton;
                        },
                    },
