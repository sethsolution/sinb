...
<script>
    ...
    var snippet_datatable_list = function () {
        ...
        var exporta_titulo = "Administrar_Cupos";
        var exporta_columnas = [':visible :not(.noExport)' ];

        var initTable1 = function() {
            // begin first table
		//console.log({/literal}{json_encode($gestionVer)}{literal});
                ...
                columnDefs: [
                    {
                        ...
                        render: function(data, type, full, meta) {
                            var boton = '';
                            if ('{/literal}{$rol_itemId}{literal}'==='1'){
                            boton = ''+
                    ...
                    
                    {
                        ...
                        render: function(data, type, full, meta ){
                            var estado = "";
                            if(Number(full.cupo_parcial)<Number(full.cupo_total))
                            {
                                estado="<div style='color:orange;'><strong>Faltante en "+(full.cupo_total-full.cupo_parcial)+"</strong><div> ";
                            }
                            else{
                                if(Number(full.cupo_parcial)>Number(full.cupo_total)){
                                estado="<div style='color:red;'><strong>Excedente</strong><div> ";}
                                else{
                                estado="<div style='color:green;'><strong>Aceptado</strong><div> ";
                                }
                            }
                            return estado;
                            }
