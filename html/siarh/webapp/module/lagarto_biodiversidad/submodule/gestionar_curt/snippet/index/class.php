...
class Index extends Table {
    ...
    function get_item($idItem,$tipoTabla,$variante=""){
        ...
        if($idItem!=''){
            if($tipoTabla=='tipo'){
                ...
                $sqlSelect = ' i.*';
                $sqlFrom = ' departamento i,usuario u2';
                $sqlWhere = ' i.itemId='.$idItem.'  and i.estado=1 and u2.rol_itemId=1 and u2.itemId='.$_SESSION["memberId"];
            }
    ...
    function item_delete($id){
        $campo_id="itemId";
        $res = $this->item_soft_delete_sbm($id,$campo_id,"curtiembre");
        return $res;
    }
