...
class core{
    ...
    function getUsuarioInfo($id){
        global $db;
        $sql = "select * from  ".$this->tabla["usuario"]." as u where u.itemId ='".$id."' ";
        ...
        foreach ($tablas as $valor) {
            ...
            if( isset($valor["alias"]) and isset($valor["tabla"]) ){
                ...
                if ($tipo == "c") { //catalogo
                    ...
                    $valor["tabla"] = $dbname_str."catalogo_" . $valor["tabla"];
                }elseif($tipo=="o"){
                    ...
                    $valor["alias"] = $tipo_str.$valor["alias"];
                    $valor["tabla"] = $dbname_str.$valor["tabla"];
                }
    ...
    public function get_module_menu($id){
        ...
        foreach ($modulo as $row){
            ...
            if($_SESSION["userv"]["tipoUsuario"]==0 || $_SESSION["userv"]["tipoUsuario"]==1){
                $sql = "select 1 as ver, m.carpeta as modulo_id_tipo_carpeta
