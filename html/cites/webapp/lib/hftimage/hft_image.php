...
require("./lib/hftimage/hft_image_errors.php"); // here you can include your own language error file
	...
	class hft_image {
        ...
        function __construct($file_original){
            ...
            if($image){ 
                switch($image_type) { 
                    ...
                    case 'JPG': 
                        ...
                        $res = ImageJpeg($image, $destination_file, (int)$this->jpeg_quality); 
                    break; 
                    case 'PNG': 
