...
<script>
    ...
    function item_form_{/literal}{$subcontrol}{literal}(id,type){
        var load_url = '{/literal}{$path_url}/{$subcontrol}_/0{literal}';
        if(type=='update'){
            load_url += '/'+id+'/';
        }else{
            load_url += '/nuevo';
    ...
    function item_descarga_{/literal}{$subcontrol}{literal}(id){
        url= "{/literal}{$path_url}/{$subcontrol}_/{literal}"+id+"/descarga/";
    ...
    function itemDeleteAction_{/literal}{$subcontrol}{literal}(id){
        ...
        randomnumber=Math.floor(Math.random()*11);
        var url = "{/literal}{$path_url}/{$subcontrol}_/{literal}"+id+"/borrar/";
        $.get( url, { random:randomnumber},
            function(res){
                if(res.res == 1){
                    swal.close();
                ...
                columnDefs: [
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            if( full.estado_id == '1' || full.estado_id == '3' ){
                                /*if( full.categoria_id=='Empresa' && full.id_estado != '4'){*/
