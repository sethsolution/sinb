...
<div class="m-portlet m--margin-bottom-5">
    ...
    <form class="m-form m-form--fit m-form--label-align-right" method="POST"
          action="{$path_url}/{$subcontrol}_/guardar.detalle/"
          id="general_form">
                    ...
                    <div class="col-lg-12  m-form__group-sub" >
                        <div class="cuadro m--padding-5 row">
                            ...
                            <div class="col-lg-3 m-form__group-sub">
                                <label class="form-control-label">Cantidad de Especie 1 (Pt):</label>
                                <div class="input-group">
                            ...
                            <div class="col-lg-3 m-form__group-sub">
                                <label class="form-control-label">Cantidad de especie 2 (Pt):</label>
                                <div class="input-group">
                                    <input type="text" class="form-control m-input numero_entero"
                                           placeholder="Ingrese la cantidad" name="item[papmp_especie1_cantidad]"
                            ...
                            <div class="col-lg-3 m-form__group-sub">
                                <label class="form-control-label">Cantidad de especie 3 (Pt):</label>
                                <div class="input-group">
                                    <input type="text" class="form-control m-input numero_entero"
    ...
    {if ($item.estado_id ==1 or $item.estado_id ==3)}
        <div class="alert alert-primary alert-dismissible fade show   m-alert m-alert--air m-alert--outline" role="alert">
            ...
            <span class="m-nav__link-wrap">
                <span class="m-nav__link-text">Si ya completo el registro de la información solicitada, envie su solicitud, dando clic sobre la opción <strong>"ENVIAR INFORMACIÓN"</strong> de la parte superior.</span>
