<!--begin::Portlet-->
    ...
    <form class="m-form m-form--fit m-form--label-align-right" method="POST"
          action="{$path_url}/{$subcontrol}_/{$id}/guardar/"
          id="general_form">
        ...
        <div class="m-portlet__body m--padding-bottom-5">
            ...
            <div class="form-group m-form__group m-form row {if $item.ocasional_id != "2" and $item.ocasional_id != ""} m--hide{/if}"  id="ocasional_div">
                ...
                <div class="ayuda col-lg-12">
                    <span class="m-form__help text-info">Formato de llenado (ejemplo): Gobierno Autónomo Departamental Beni</span>
                </div>
                {/if}
    ...
    {if $item.estado_id ==1 or $item.estado_id ==3  and $item.observado == 1}
    ...
    {if ($item.estado_id == 1 or $item.estado_id == 3) and  $item.tipo_id != 8}
        <div class="alert alert-primary alert-dismissible fade show   m-alert m-alert--air m-alert--outline" role="alert">
            ...
            <span class="m-nav__link-title">
                <span class="m-nav__link-wrap">
                    <span class="m-nav__link-text">Debe continuar con el registro de documentos, en la pestaña <strong> "REQUISITOS"</strong> de la parte superior.</span>
        ...
        <div class="alert alert-primary alert-dismissible fade show   m-alert m-alert--air m-alert--outline" role="alert">
            ...
            <span class="m-nav__link-title">
                <span class="m-nav__link-wrap">
                    <span class="m-nav__link-text">Puede continuar con su trámite en el menú lateral <strong> "OTROS TRÁMITES"</strong>.</span>
                    <i class="m-nav__link-icon flaticon-chat-1"></i>
                </span>
            </span>
        </div>
