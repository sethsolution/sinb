                                ...
                                <div class="col-lg-6 m-form__group-sub">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control m-input numero_decimal monto"
                                               ...
                                               required data-msg="Este campo es requerido." name="item[venta_monto]"
                                                {$privFace.input} value="{$item.venta_monto|escape:'html'}"
                                               data-msg="Este campo es requerido.">
                                    </div>
                                </div>
                                <div class="col-lg-6 m-form__group-sub">
                                    <label class="form-control-label">Monto de Venta (Dolares.):</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control m-input numero_decimal monto"
                                               placeholder="Ingrese el monto de venta en dolares"
                                               required data-msg="Este campo es requerido." name="item[venta_monto_usd]"
                                                {$privFace.input} value="{$item.venta_monto_usd|escape:'html'}"
                                               data-msg="Este campo es requerido.">
                                    </div>
                                </div>
                                <div class="col-lg-6 m-form__group-sub">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control m-input numero_decimal"
                                               ...
                                               required data-msg="Este campo es requerido." name="item[venta_cantidad]"
                ...
                {if $item.tipo_id == 3}
                    <div class="form-group m-form__group row m--padding-top-5 m--padding-bottom-5 " >
                        <div class="col-lg-12  m-form__group-sub" >
                            <div class="cuadro m--padding-5 row">
                                <div class="col-lg-12 titulo m--margin-bottom-5 m--padding-left-5">
                     Certificado CITES de exportación, importación y re-exportación (si corresponde)
                                </div>
