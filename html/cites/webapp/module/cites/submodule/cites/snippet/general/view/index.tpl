        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h5 class="m--font-success">Paso 1: Registro de datos generales</h5>
                </div>
            </div>
        </div>
                ...
                <div class="form-group m-form__group row m--padding-bottom-5 m--padding-top-5 m--padding-bottom-5" >
                    <div class="col-lg-12 m-form__group-sub m--padding-right-5 m--padding-left-5 " >
                        <div class="cuadro-verde m--padding-10" >
                            ...
                            <div class="col-lg-12 titulo m--margin-bottom-5 m--padding-left-5">Tipo de producto a movilizar (certificación CITES):</div>
                ...
                <div class="form-group m-form__group row m--padding-bottom-5 m--padding-top-5" >
                    ...
                    <div class="col-lg-3 m-form__group-sub m--padding-right-5 m--padding-left-5" >
                        <div class="cuadro m--padding-10">
                            ...
                            <div class="m-input-icon m-input-icon--right"  style="text-align: justify;">
                                {if $item.estado_id == "4"}
                    ...
                    <div class="col-lg-6  m-form__group-sub m--padding-right-5 m--padding-left-5" >
                        <div class="cuadro m--padding-10">
                            ...
                            <div class="col-lg-12 m-form__group-sub cuadro-padding-0">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control m-input mayus" placeholder="Ingrese la dirección del importador" name="item[importador_direccion]" cols="4" required data-msg="Este campo es requerido, registre la información." {$privFace.input}>{$item.importador_direccion|escape:'html'}</textarea>
                                    <div class="input-group-append"><span class="input-group-text" id="basic-addon2"><i class="fa fa-map-marker-alt"></i></span></div>
                                </div>
                                <span class="m-form__help text-danger text-info m--valign-top ">Ejemplo de llenado:</span>
                    ...
                    <div class="col-lg-6  m-form__group-sub m--padding-right-5 m--padding-left-5" >
                        <div class="cuadro m--padding-10">
                            ...
                            <div class="col-lg-12 m-form__group-sub cuadro-padding-0">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control m-input mayus" placeholder="Ingrese la dirección del exportador" name="item[exportador_direccion]" cols="4" required data-msg="Este campo es requerido, registre la información." {$privFace.input}>{$item.exportador_direccion|escape:'html'}</textarea>
                                    <div class="input-group-append"><span class="input-group-text" id="basic-addon2"><i class="fa fa-map-marker-alt"></i></span></div>
                                </div>
                                <span class="m-form__help text-danger text-info m--valign-top">Ejemplo de llenado:</span>
                                <span class="m-form__help text-info text-info ">
                    ...
                    <div class="col-lg-6 row  m-form__group-sub cuadro-margin-0 cuadro-padding-0" >
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control m-input mayus nollenar"
                                           placeholder="" name="item[condiciones_especiales]"
                                            {$privFace.input} {if $item.estado_id == "4"}value="{$item.condiciones_especiales|escape:'html'}"{/if}
                                           data-msg="Este campo es requerido, registre la información." disabled>
                                </div>
                                <span class="m-form__help text-info">
                                        Las condiciones especiales se mostrarán una vez aprobada la solicitud.
                                     <br><span style="color: #990a1e">(No llenar) </span>
                                 </span>
                            </div>
                        </div>
                        <div class="col-lg-6  m-form__group-sub m--padding-right-5 m--padding-left-5 m--padding-bottom-10" >
                            <div  class="cuadro m--padding-10">
                                ...
                                <span class="m-form__help text-info">
                                        Opcional si se conoce su llenado <br>
                                        <span style="color: #990a1e">Nota: Recuerde que solo puede elegir una opción de transacción </span>
                                     </span>
                            </div>
                        </div>
                        <div class="col-lg-6  m-form__group-sub m--padding-right-5 m--padding-left-5 m--padding-bottom-10" >
                            <div  class="cuadro m--padding-10">
                                <div class="col-lg-12 titulo2 m--margin-bottom-5 m--padding-left-5">5b. Estampilla de seguridad:</div>
                                    ...
                                    <span class="m-form__help text-info">
                                        Estampilla de seguridad fijada <br><span style="color: #990a1e">(No llenar) </span>
                                     </span>
                            </div>
                        </div>
                        <div class="col-lg-12  m-form__group-sub m--padding-right-5 m--padding-left-5 m--padding-bottom-10" >
...
{*
            <div class="m-form__actions m-form__actions--solid m-form__actions--left">
                {if $item.estado_id ==1 or $item.estado_id ==3 or $type == 'new'}
    ...
    <div class="alert alert-primary alert-dismissible fade show   m-alert m-alert--air m-alert--outline" role="alert">
        ...
        <span class="m-nav__link-title">
            <span class="m-nav__link-wrap">
                <span class="m-nav__link-text">Debe continuar con el registro de especies, en la opción <strong> "PASO 2"</strong> de la parte superior.</span>
