            ...
            <div class="form-group m-form__group row m--padding-bottom-5 m--padding-top-4" >
                ...
                <div class="col-lg-3 m-form__group-sub m--padding-right-5 m--padding-left-5" >
                    <div class="cuadro m--padding-10">
                        <div class="col-lg-12 tituloresumen m--margin-bottom-5 m--padding-left-5">1. Permiso / Certificado:</div>
                ...
                <div class="col-lg-3 m-form__group-sub m--padding-right-5 m--padding-left-5" >
                    <div class="cuadro m--padding-10">
                        <div class="col-lg-12 tituloresumen m--margin-bottom-5 m--padding-left-5">2. Válido Hasta el :</div>
                    </div>
                </div>

                <div class="col-lg-6  m-form__group-sub m--padding-right-5 m--padding-left-5" >
                    <div class="cuadro m--padding-10">
                        <div class="col-lg-12 tituloresumen m--margin-bottom-5 m--padding-left-5">3. Importador (nombre, dirección):</div>
                ...
                <div class="col-lg-6  m-form__group-sub m--padding-right-5 m--padding-left-5" >
                    <div class="cuadro m--padding-10">
                        <div class="col-lg-12 tituloresumen m--margin-bottom-5 m--padding-left-5">4. Exportador / re-exportador (nombre, direccón y país):</div>
                        <div class="col-lg-12 m-form__group-sub cuadro-padding-0">
                            <div class="col m--align-center">
                ...
                <div class="col-lg-6 row  m-form__group-sub cuadro-margin-0 cuadro-padding-0" >
                    <div class="col-lg-12  m-form__group-sub m--padding-right-5 m--padding-left-5 cuadro-margin-0 m--padding-bottom-10"  >
                        <div  class="cuadro m--padding-10 " >
                            <div class="col-lg-12 tituloresumen m--margin-bottom-5 m--padding-left-5">3a. País de Importación:</div>
                    ...
                    <div class="col-lg-12  m-form__group-sub m--padding-right-5 m--padding-left-5 m--padding-bottom-10" >
                        <div  class="cuadro m--padding-10">
                            <div class="col-lg-12 tituloresumen m--margin-bottom-5 m--padding-left-5">5. Condiciones Especiales:</div>

                        </div>
                    </div>
                    <div class="col-lg-6  m-form__group-sub m--padding-right-5 m--padding-left-5 m--padding-bottom-10" >
                        <div  class="cuadro m--padding-10">
                            <div class="col-lg-12 tituloresumen m--margin-bottom-5 m--padding-left-5">5a. Propósito de la transacción:</div>
                            <div class="col m--align-center">
                    ...
                    <div class="col-lg-6  m-form__group-sub m--padding-right-5 m--padding-left-5 m--padding-bottom-10" >
                        <div  class="cuadro m--padding-10">
                            <div class="col-lg-12 tituloresumen m--margin-bottom-5 m--padding-left-5">5b. Estampilla de seguridad :</div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6  m-form__group-sub m--padding-right-5 m--padding-left-5" >
                    <div class="cuadro m--padding-10">
                        <div class="col-lg-12 tituloresumen m--margin-bottom-5 m--padding-left-5">6. Nombre, Dirección, Sello/timbre nacional y país de la Autoridad Administrativa:</div>
