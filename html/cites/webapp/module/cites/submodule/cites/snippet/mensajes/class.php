...
class Snippet extends Table
{
    ...
    public function get_item_datatable_Rows($item_id){
         ...
         */
        $extraWhere = "cites_id='" . $item_id . "' and i.empresa_id = " . $this->empresa_id;
    ...
    function item_update($rec,$itemId,$que_form,$accion,$item_id){
        ...
        if($item['itemId'] != "" or $accion=="new"){
            $campo_id="itemId";
            $where =  "cites_id='" . $item_id . "' and i.empresa_id = " . $this->empresa_id;
    ...
    function procesa_datos($que_form,$rec,$accion="new",$item_id){
        ...
        switch($que_form){
            case 'index':
                ...
                if ($accion == "new") {
                    //print_struc( $this->empresa_id); exit();
    ...
    function get_item($id,$item_id){
        $sql = "select * from ".$this->tabla["mensaje"]." as p where p.itemId = '".$id."' and p.cites_id = '".$item_id."' and empresa_id = '" . $this->empresa_id. "'";
    ...
    function item_delete($id,$item_id){
        $campo_id="itemId";
        $where =  "cites_id='" . $item_id . "' and i.empresa_id = " . $this->empresa_id;
        //$where = "cites_id='" . $item_id . "' and empresa_id = '15'";
