<table style="background-image: url('{$path_image}pdf/nooficial.png'); background-repeat: no-repeat;
    ...
    <tr>
        ...
        <td rowspan="5" class="respuesta2" height="130">
            <img src="{$path_image}pdf/logo.png" width="100px" style="float: left; margin: 0.5em;" /><br>
...
<div class="m-section__content">
    ...
    <table>
        ...
        <tr>
            <td rowspan="2" class="pregunta2" width="30"><img src="{$path_image}pdf/sustentable.jpg" width="100px" style="float: left; margin: 0.5em;" /></td>
