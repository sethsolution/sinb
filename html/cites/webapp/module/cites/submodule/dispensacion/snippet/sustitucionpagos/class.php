...
class Snippet extends Table
{
    ...
    public function get_item_datatable_Rows($item_id){
         ...
         */
        $extraWhere = " i.empresa_id = ".$this->empresa_id." and i.categoria_id=7 and i.dispensacion_id='".$item_id."' ";
    ...
    function item_update($rec,$itemId,$que_form,$accion,$item_id,$input_archivo){
        ...
        if($bandera==1){
            ...
            $respuesta_procesa["sustitucion_id"] = $sus_detalle["itemId"];
            ...
            if(($item["itemId"]!="" and $item["modifica"]==1)  or $accion=="new"){
                ...
                $campo_id="itemId";
                $where = " empresa_id = '".$this->empresa_id."' and dispensacion_id= '".$item_id."' and categoria_id=7  " ;
            ...
            }else if(isset($item['categoria_id']) and $item['categoria_id']!=7){
                $res['res'] = 2;
        ...
        switch($que_form){
            case 'archivo':
                ...
                if ($accion=="new"){
                    ...
                    $dato_resultado["categoria_id"] = 7; //Sustitución
    ...
    function get_item($id,$item_id, $all=0){
        ...
        and empresa_id = '" . $this->empresa_id. "' and categoria_id= '7' and dispensacion_id='".$item_id."'";
        }else{
            $sql = "select * from ".$this->tabla["empresa_pago"]." as p where p.itemId = '".$id."' 
         ...
         */
        if( ($item['itemId'] != "" and  $item['categoria_id']==7)
