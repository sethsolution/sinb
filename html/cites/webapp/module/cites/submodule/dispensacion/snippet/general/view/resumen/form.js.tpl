...
<script>
    var table_list;
    var snippet_datatable_especie = function () {
        ...
        var initTable1 = function() {
            // begin first table
            table_list = $('#tabla_especies').DataTable({
        ...
        var initTable2 = function() {
            // begin first table
            table_list = $('#tabla_requisito').DataTable({
                initComplete: function(settings, json) {
    ...
    jQuery(document).ready(function() {
        ...
        snippet_datatable_especie.init();
    });
