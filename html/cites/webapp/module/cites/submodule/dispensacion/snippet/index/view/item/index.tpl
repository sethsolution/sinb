                ...
                <div class="m-portlet__head-tools">
                    <div class="m-portlet__head-caption">
                        ...
                        {if $item.estado_id == 1 or $item.estado_id == 3}
                            <a href="#" class="btn btn-success m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10"  id="btn_enviar" rel="new">
                        ...
                        {else}{if $item.estado_id == 2}
                            <div class="cuadro-verde m--padding-10 m--margin-bottom-10" style=" height: 50%">
                                <div class="titulomensaje m--margin-bottom-5 m--padding-left-5 m--font-bold">Su solicitud fue enviadada con exito, espere a recibir una notificación.</div>
                            </div>
                        {/if}
                        {/if}
                        {*{if $item.estado_id==4 or $item.estado_id==7 }
                            <a href="#" class="btn btn-success m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10"
                               id="btn_sustituir" rel="new">
                                <span><i class="fa fa-plus"></i><span>SUSTITUIR CERTIFICADO</span></span>
                            </a>
                        {/if}
    *}
                    </div>
