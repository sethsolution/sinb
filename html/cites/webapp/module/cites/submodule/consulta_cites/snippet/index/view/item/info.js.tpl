...
<script>
    var snippet_resumen = function () {
        ...
        var handler_resumen01 = function(){
            loadurl = "{/literal}{$path_url}/{$id}/resumen01{literal}";
            $.get(loadurl, function(data) {
                $("#resumen01").html(data);
            });
        };
        var handler_resumen02 = function(){
            var loadurl = "{/literal}{$path_url}/{$id}/resumen02{literal}";
    ...
    var snippet_avatar = function(){
        ...
        var avatar_src= '{/literal}{$path_url}/{$id}/foto.get/?type=3{literal}';
