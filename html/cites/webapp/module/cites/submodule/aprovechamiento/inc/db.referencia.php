 ...
 * Objeto CITES
 */
$objdb = "aprovechamiento";
$db_datos[] = $core->get_alias_campo($objdb,"","");
$db_prefix = $objdb."_";
$db_datos[] = $core->get_alias_campo($db_prefix."archivo",$db_prefix,"");
$db_datos[] = $core->get_alias_campo($db_prefix."utilizado",$db_prefix,"");
$db_datos[] = $core->get_alias_campo($db_prefix."conteo",$db_prefix,"");
/**
 * Objeto Empres
 */
$objdb = "empresa";
...
$db_datos[] = $core->get_alias_campo("aprovechamiento_tipo","","");
$db_datos[] = $core->get_alias_campo("aprovechamiento_tipo_requisito","","");
