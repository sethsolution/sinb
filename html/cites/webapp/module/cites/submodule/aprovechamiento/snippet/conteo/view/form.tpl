                    ...
                    <div class="form-group m-form__group row m--padding-top-5 m--padding-bottom-5 " >
                        <div class="col-lg-12  m-form__group-sub" >
                            <div class="cuadro m--padding-5 row">
                                <div class="col-lg-12 titulo m--margin-bottom-5 m--padding-left-5">Codigo de los Precintos utilizados</div>
                                <div class="col-lg-6 m-form__group-sub">
                                    <div class="input-group">
                                        <input type="text" class="form-control m-input"
                                               placeholder="Ingrese el codigo" name="item[codigo_conteo]"
                                                {$privFace.input} value="{$item.codigo_conteo|escape:'html'}"
                                ...
                                </div><div class="col-lg-6 m-form__group-sub">
                                    <div class="input-group">
                                        {if $item.estado_id ==1 or $item.estado_id ==3}
                                            <button type="reset" class="btn btn-primary" id="general_submit">
                                                <span>Guardar y continuar con el registro de documentación&nbsp;&nbsp;<i class="fa fa-angle-double-right"></i></span>
                                            </button>
                                        {/if}
                                    </div>
                                </div>
