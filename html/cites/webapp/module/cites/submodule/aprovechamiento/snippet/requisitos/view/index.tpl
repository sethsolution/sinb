    ...
    {if $item_padre.estado_id ==1 or $item_padre.estado_id ==3}
        ...
        <span class="m-nav__link-badge">
            ...
            <span class="m-nav__link-wrap">
                <span class="m-nav__link-text">Si ya termino el registro de la información solicitada, debe enviar el reporte, mediante la opción <strong> "ENVIAR REPORTE"</strong> de la parte superior.</span>
