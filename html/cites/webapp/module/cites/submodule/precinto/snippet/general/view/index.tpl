                            ...
                            <div class="input-group">
                                {if $type == 'new'}
                                    <select class="form-control m-select2 select2_general "
                                        ...
                                        <option value=""></option>
                                        {html_options options=$cataobj.precinto_tipo selected=$item.tipo_id}
                                    </select>
                                {else}
                                    {$item.precinto_tipo}
                                {/if}
    ...
    <div class="alert alert-primary alert-dismissible fade show   m-alert m-alert--air m-alert--outline" role="alert">
        ...
        <span class="m-nav__link-wrap">
                        <span class="m-nav__link-text">
                            Debe continuar con el registro de documentos, en la pestaña "REQUISITOS" de la parte superior.
                        </span>
                    </span>
