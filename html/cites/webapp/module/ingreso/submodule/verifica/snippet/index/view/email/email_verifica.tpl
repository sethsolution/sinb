...
>
    ...
    <br>
        Realizaste la solicitud para la creaci&oacute;n de usuario dentro del sistema CITES BOLIVIA.
<br><br>
        Para poder activar tu cuenta, haz click en el siguiente boton.
        <br><br>
        <a href="{$url_dominio}/ingreso/registro/verifica/?c={$verifica_codigo}&e={$email_user}" style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block;
