...
<form class="login100-form validate-form" style="padding-bottom: 20px!important;">
    ...
    <div class="error  dis-none m-b-19 w-full p-1  text-center lh-2-3" id="error"> El usuario o la contraseña son incorrectos.
    </div>
