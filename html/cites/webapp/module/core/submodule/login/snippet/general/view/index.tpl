        ...
        <div class="m-portlet__body">
            ...
            <div class="form-group m-form__group row">
                <div class="col-lg-6">
                    ...
                    <div class="m-input-icon m-input-icon--right">
                        <select class="form-control m-select2 select2_general" name="item[proveedor_id]"  data-placeholder="Elija un proveedor" {$privFace.input} data-msg="Campo requerido" required>
                            <option></option>
                ...
                <div class="col-lg-6">
                    <label>Lugar:</label>
                    <div class="m-input-icon m-input-icon--right">
                        <select class="form-control m-select2 select2_general" name="item[lugar_id]"  data-placeholder="Elija un lugar" {$privFace.input} data-msg="Campo requerido" required>
                            <option></option>
