...
class Catalogo extends Table{
    ...
    public function conf_catalog_datos_general(){
        $this->addCatalogList($this->tabla["c_ip_publica"],"ippublica","","ip","","","","");
        $this->addCatalogList($this->tabla["c_lugar"],"lugar","nombre","","","","","");
        $this->addCatalogList($this->tabla["c_proveedor"],"proveedor","nombre","","","","","");
    }
