...
class Index extends Table {
    ...
    function item_delete($id){
        $campo_id="itemId";
       /* $this->dbm->debug=true;*/
        $res = $this->item_delete_sbm($id,$campo_id,$this->tabla["c_ip_publica"]);
        //exit;
        return $res;
    }
...
//echo "=>".$sql;exit;
    ...
    function getUserPrint(){
        ...
        $sql = "SELECT CONCAT(u.nombre,' ',u.apellido) as username FROM usuario u WHERE u.itemId=".$this->userId;
        $info = $db->Execute($sql);
        return $info->fields;
    }
