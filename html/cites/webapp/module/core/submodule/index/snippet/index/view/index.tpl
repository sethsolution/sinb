                        ...
                        <div class="m-widget19__content" >
                            <div class="m-widget19__header m--margin-top-10">
                                <div class="m-widget19__stats">
                                    {if $row.descripcion != ''}
                                        <button type="button" class="btn btn-accent m-btn m-btn--icon m-btn--icon-only m-btn--custom m-btn--pill btn btn-info "
                                                data-toggle="modal" data-target="#m_modal_{$row.itemId}" title="Más Información"><i class="fa fa-cogs"></i></button>
                                    {/if}
                                </div>
                                {*
                            ...
                            <div class="modal fade" id="m_modal_{$row.itemId}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel_{$row.itemId}" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer"><button type="button" class="btn  btn-outline-info active" data-dismiss="modal">Cerrar</button>                                        </div>
                                    </div>
                                </div>
                            </div>
                            <!--end::Modal-->
