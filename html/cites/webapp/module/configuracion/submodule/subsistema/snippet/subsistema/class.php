...
class Snippet extends Table
{
    ...
    public function get_item_datatable_Rows($item_id){
         ...
         */
        //$extraWhere = "moduloId='".$item_id."'";
        $extraWhere = "i.moduloId='".$item_id."'and i.parent != 0" ;
        ...
        switch($que_form){
            case 'submodulo':
                ...
                switch ($dato_resultado["tipo"]){
                    case 'URL':
                        //$dato_resultado["tipo"]= "URL";
                        $dato_resultado["submodulo_id"]= NULL;
                        $dato_resultado["modulo_id_tipo"]= NULL;
                        $dato_resultado["carpeta"]=NULL;
                        break;
                    case 'INDEX':
                        //$dato_resultado["tipo"]= "INDEX";
                        $dato_resultado["submodulo_id"]= NULL;
                        $dato_resultado["url"]= "";
                        $dato_resultado["carpeta"]=NULL;
                        break;
                    case 'SB':
                        //$dato_resultado["tipo"]= "SB";
                        $dato_resultado["url"]= "";
                        $dato_resultado["modulo_id_tipo"]= NULL;
                        $dato_resultado["carpeta"]=NULL;
                        break;
                    case 'CARPETA':
                       // $dato_resultado["carpeta"]=strtolower(trim($rec["carpeta"]));
                        //$dato_resultado["tipo"]= "CARPETA";
                        $dato_resultado["submodulo_id"]= NULL;
                        $dato_resultado["modulo_id_tipo"]= NULL;
                        $dato_resultado["url"]="";
                        break;
    ...
    function item_delete($id,$item_id){
        ...
        //$this->dbm->debug = true;
        /**
         * Borrado de datos de la tabla submodulo del core
         */
        $campo_id="subModuloId";
        $res = $this->item_delete_sbm($id,$campo_id,$this->tabla["o_usuario_permisos"]);
