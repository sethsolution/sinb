        ...
        <div class="form-group row">
            <div class="col-lg-12">
                ...
                <div class="m-input-icon m-input-icon--right">
                    <select class="form-control m-select2 select2_general" name="item[categoria_id]" id="categoria" style="width: 100%;"
                            data-placeholder="Elija la Direccion" {$privFace.input} data-msg="Campo requerido" value="">
                        <option></option>
