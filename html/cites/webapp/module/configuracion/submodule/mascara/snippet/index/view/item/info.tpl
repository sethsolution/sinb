...
<div class="m-portlet  m-portlet--bordered-semi " style="margin-bottom: 0px !important;">
        ...
        <div class="m-portlet__head-caption">
            <div class="m-portlet__head-title">
                ...
                <h3 class="m-portlet__head-text">
                    Nombre de Categoria: &nbsp; <strong><span class="m--font-success" id="cat_id" data-id="{$item.itemId}">{$item.nombre}</span></strong>
                </h3>
            </div>
        </div>
    ...
    <div class="m-portlet__body m--padding-bottom-5" >
        <strong>Nombre: <span class="m--font-success">{$item.nombre}</span></strong>
    </div>*}
</div>
<!--end::Portlet-->