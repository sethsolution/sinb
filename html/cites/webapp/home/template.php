...
$frontend["login"] = $templateSmoduleCore."core_login.tpl";

$frontend["email_base"] = $templateSmoduleCore."email_base.tpl";
...
$marca='2020 &copy; <a href="javascript:void(0);" class="m-link">CITES </a> - mmaya.gob.bo ';
$version = "0.1.0";
