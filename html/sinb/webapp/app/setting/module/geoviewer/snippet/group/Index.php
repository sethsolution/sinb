<?PHP
namespace App\Setting\Module\Geoviewer\Snippet\Group;
use Core\CoreResources;
class Index extends CoreResources
{
    var $objTable = "geoviewer_group";
    ...
    public function getItemDatatableRows($item_id){
         ...
         */
        $extraWhere = "geoviewer_id='".$item_id."' " ;
        $groupBy = "";
        $having = "";
        /**
        ...
        switch($form){
            case 'index':
                ...
                if ($action=="new"){
                    ...
                    $dataResult["geoviewer_id"]= $item_id;
                }
                break;
    ...
    function getItem($id,$item_id){
        $sql = "select * from ".$this->table[$this->objTable]." as p where p.id = '".$id."' and p.geoviewer_id = '".$item_id."'";
