    ...
    var snippet_list = function() {
        ...
        var initTable = function() {
            ...
            table_list = table_list_var.DataTable({
                ...
                pageLength: 50,
                order: [[ 0, "asc" ],[ 1, "asc" ],[4, "asc" ]], // Por que campo ordenara al momento de desplegar
                InfoFiltered: false,
                searchDelay: 500,
                processing: true,
                serverSide: true,
                ...
                columnDefs: [
                    ...
                    { targets: [0,1,9], visible:false,searchable: false,},
                    { targets: [3,4,6,11,12], searchable: false,},
                    {
                        targets: [ 2 ],
                        orderData: [0,1,2],
                        render: function(data,type,full,meta){
                            return '<span class="font-weight-bolder text-primary center">' + data + '</span>';
                        },
                    },
                    { targets: [3], orderData: [0,1,3]},
                    { targets: [4], orderData: [0,1,4]},
                    {
                        targets: [5],
                        orderable: false,
                        render: function(data,type,full,meta){
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            return '<i class="fa fa-external-link-alt text-' + status[data].state + '"></i>';
                        },
                    },
                    {
                        targets: 7,
                        ...
                        render: function(data, type, full, meta) {
                            var status = {
                                'app': {'title': 'FOLDER', 'class': ' label-light-warning'},
                        ...
                        render: function(data,type,full,meta){
                            if(full.type =="app"){
                                if (data == null){
                                    ...
                                    var res = '<span class="label label-lg font-weight-bold label-info label-inline"><i class="text-white fas fa-folder-open mr-2"></i>' + data + '</span>';
                                }
                            }else if(full.type =="url"){
                                var res = full.url;
                            }
                            return res;
                        },
                    ...
                    { targets: [9], orderData: [0,1,9]},
                    { targets: [10], orderData: [0,1,10]},
                    {
                        targets: [11],
                        orderData: [0,11],
                        width: '60px',
