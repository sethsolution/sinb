<?PHP
namespace App\Setting\Module\Geoserver\Snippet\Layer;
use Core\CoreResources;
class Index extends CoreResources
{
    var $objTable = "geoserver_layer";
    ...
    public function getItemDatatableRows($item_id){
         ...
         */
        $extraWhere = "geoserver_id='".$item_id."' " ;
        $groupBy = "";
        $having = "";
        /**
        ...
        switch($form){
            case 'index':
                ...
                if ($action=="new"){
                    ...
                    $dataResult["geoserver_id"]= $item_id;
                }
                break;
    ...
    function getItem($id,$item_id){
        $sql = "select * from ".$this->table[$this->objTable]." as p where p.id = '".$id."' and p.geoserver_id = '".$item_id."'";
