...
<div class="card card-custom gutter-b example example-compact">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-3">
                <label>{#fieldAuthName#}:</label>
                <div class="input-group">
                    <span class="switch switch-icon">
                        <label><input type="checkbox" {if $item.private == 1}checked="checked"{/if} name="item[auth]" value="1" ><span></span></label>
                    </span>
                </div>

                <span class="form-text text-muted">{#fieldAuthMsg#}</span>
            </div>
