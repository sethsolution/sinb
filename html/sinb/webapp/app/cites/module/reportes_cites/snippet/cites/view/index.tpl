    ...
    <form method="POST"
        ...
        <div class="card-body  pt-1 pb-0 programa" >
            <div class="form-group row  pt-0 pb-0 mb-0">
                ...
                <div class="col-lg-6">
                    <label>{#field_tipo_documento_id#} : </label>
                    <div class="input-group">
                        <select class="form-control m-select2 select2_general"
                                name="item[tipo_documento_id][]" id="tipo_documento_id"
                                data-placeholder="{#field_holder_tipo_documento_id#}"
                                multiple
                ...
                <div class="col-lg-6">
                    <label>{#field_tipo_proposito_id#} : </label>
                    <div class="input-group">
                        <select class="form-control m-select2 select2_general"
                                name="item[proposito_id][]" id="type_select_tipo"
                                data-placeholder="{#field_holder_tipo_proposito_id#}"
                                multiple
                                data-fv-not-empty___message="{#glFieldRequired#}"
                        >
                    ...
                    <span class="form-text text-black-50">{#field_msg_tipo_proposito_id#}</span>
                </div>
                ...
                <div class="col-lg-6">
                    <label>{#field_year#} : </label>
                    <div class="input-group">
                        <select class="form-control m-select2 select2_general"
                                name="item[year][]" id="year"
                                data-placeholder="{#field_Holder_year#}"
                                multiple
                                data-fv-not-empty___message="{#glFieldRequired#}"
                        >
                            <option></option>
                            {html_options options=$cataobj.esquila_year selected=$item.year}
                        </select>
                    </div>
                    <span class="form-text text-black-50">{#field_GroupMsg_year#}</span>
                </div>
            </div>
        </div>
