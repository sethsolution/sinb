    ...
    {if $item.id != "" or $type == 'new'}
        <div class="modal-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-4">
                    <label>{#field_unidad#} <span class="text-danger bold">*</span> :</label>
                    <input type="text" class="form-control"
                           name="item[unidad]"
                           value="{$item.unidad|escape:"html"}"
                           placeholder=""
                           required
                           data-fv-not-empty___message="{#glFieldRequired#}"
                           minlength="1"
                           data-fv-string-length___message="{#field_length_unidad#}"
                    >
                    <span class="form-text text-black-50">{#field_msg_unidad#}</span>
                </div>
                <div class="col-lg-4">
                    <label>{#field_codigo#} <span class="text-danger bold">*</span> :</label>
                    <input type="text" class="form-control"
                           name="item[codigo]"
                           value="{$item.codigo|escape:"html"}"
                           placeholder=""
                           required
                           data-fv-not-empty___message="{#glFieldRequired#}"
                           minlength="1"
