<?PHP
use App\Icas\InstitucionContraparte\Ubicacion\Index;
use App\Icas\InstitucionContraparte\Ubicacion\Catalog;
use Core\Core;
use App\Icas\InstitucionContraparte\index\Index as indexParent;
$objItem = new Index();
