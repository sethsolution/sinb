    ...
    {if $item.id != "" or $type == 'new'}
        <div class="modal-body">
            ...
            <div class="form-group row">
                <div class="col-lg-6">
                    <label>{#field_fecha_acreditacion#}<span class="text-danger bold">*</span> :</label>
                    ...
                    <span class="form-text text-black-50">{#field_msg_fecha_acreditacion#}</span>
                </div>
                <div class="col-lg-6">
                    <label>{#field_fecha_expiracion#}<span class="text-danger bold">*</span> :</label>
                    <div class="input-group">
                        <input type="text" class="form-control date_general" id="valid_until"
                    ...
                    <span class="form-text text-black-50">{#field_msg_fecha_expiracion#}</span>
                </div>
            </div>
