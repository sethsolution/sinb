...
<script>
    ...
    var snippet_list = function() {
                ...
                columnDefs: [
...

                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            let boton = '<div class="text-center"><a href="javascript:snippet_list.estado(\''+full.actions+'\');" class="btn btn-icon  btn-sm" title="Cambiar estado">'+
        ...
        var estado = function (id){
            if(id!="") {
                var url = urlsys+"/"+id+"/set.estado";
                $.post(url
