            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item menu-item-active" aria-haspopup="true">
                    <a href="index.html" class="menu-link">
                        ...
                        <span class="menu-text">{$module_conf.btn_inicio_principal}</span>
                    </a>
                </li>

                <li class="menu-item menu-item-active" aria-haspopup="true">
                    <a href="/{$miga.modulo.carpeta}" class="menu-link">
                        <span class="svg-icon menu-icon">
                        <i class="m-menu__link-icon fa fa-home"></i>
                        </span>
                        <span class="menu-text">{$module_conf.btn_inicio}</span>
                    </a>
                </li>

                <li class="menu-section" style="border-bottom: 1px solid #387ec9; margin: 0px;">
                    <h4 class="menu-text">{$module_conf.menu_titulo}</h4>
                ...
                <li class="menu-item menu-item-submenu {if $miga.padre.itemId eq $row.itemId }menu-item-open menu-item-here{/if}" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text">{$row.nombre}</span>
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            <li class="menu-item menu-item-parent" aria-haspopup="true">
                                <span class="menu-link"><span class="menu-text">{$row.nombre}</span></span>
                            </li>
