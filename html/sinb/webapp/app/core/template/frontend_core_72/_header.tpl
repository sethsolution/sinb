                ...
                <ul class="menu-nav">
                    <li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here menu-item-active" data-menu-toggle="click" aria-haspopup="true">
                        <a href="javascript:;" class="menu-link menu-toggle">
                            <span class="menu-text">MMAyA</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                            <ul class="menu-subnav">
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="https://www.mmaya.gob.bo" target="_blank" class="menu-link">
                                        <i class="fab fa-react mr-2"></i>
                                        <span class="menu-text">Web MMAyA </span>
                                        <!--<span class="menu-label"><span class="label label-success label-rounded">2</span></span>-->
                                    </a>
                                </li>
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="https://www.facebook.com/Min.MedioAmbienteyAgua" target="_blank" class="menu-link">
                                        <i class="fab fab fa-facebook mr-2"></i>
                                        <span class="menu-text">Facebook MMAyA</span>
                                    </a>
                                </li>
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="https://miofi.mmaya.gob.bo/" target="_blank" class="menu-link">
                                        <i class="fas fa-info mr-2"></i>
                                        <span class="menu-text">Oficina Virtual (SIARH)</span>
                                    </a>
                                </li>
            ...
            <div class="dropdown ">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    ...
                    <div class="row row-paddingless">
                        ...
                        <!--begin:Item-->
                        <div class="col-6">
                            <a href="https://miofi.mmaya.gob.bo/" target="_blank" class="d-block py-10 px-5 text-center bg-hover-light border-right">
                                <span class=""><i class="fas fa-book text-success icon-xl-2x"></i></span>
                                <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">SIARH</span>
                                <span class="d-block text-dark-50 font-size-lg">Oficina Virtual</span>
                            </a>
                        </div>
                        <!--end:Item-->
                        <!--begin:Item-->
