            ...
            table_list = table_list_var.DataTable({
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            var status = {
                                'Buen estado': {'title': 'Buen estado', 'color': '#1ec478'},
                                'Estado regular': {'title': 'Estado regular', 'color': '#32a9dd'},
                                'Se desconoce': {'title': 'Se desconoce', 'color': '#e8ab0d'},
                                'Mal estado': {'title': 'Mal estado', 'color': '#e80d40'},
                            };
