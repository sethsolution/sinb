...
class Index extends CoreResources
{
    ...
    public function getData($item){
        ...
        $sql = "select d.name as departamento,g.*
                ...
                , (select count(*) from ".$this->table[$this->objTable]." as p2 ".$wheregd." p2.departamento_id = p.departamento_id and p2.red_id=1) as cuero
                , (select count(*) from ".$this->table[$this->objTable]." as p2 ".$wheregd." p2.departamento_id = p.departamento_id and p2.red_id=2) as carne
                , (select count(*) from ".$this->table[$this->objTable]." as p2 ".$wheregd." p2.departamento_id = p.departamento_id and p2.red_id=3) as cuerno
                , (select count(*) from ".$this->table[$this->objTable]." as p2 ".$wheregd." p2.departamento_id = p.departamento_id and p2.red_id=null) as none
